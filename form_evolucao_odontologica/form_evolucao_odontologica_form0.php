...
<?php
include_once("form_evolucao_odontologica_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_evolucao_odontologica_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-id_paciente", elem).focus(function() {
   ...
   source: function (request, response) {
    $.ajax({
     url: "form_evolucao_odontologica.php",
     dataType: "json",
     data: {
      term: request.term,
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_odontologica']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_odontologica']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_odontologica']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_odontologica']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_odontologica']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_odontologica']['recarga'];
}
?>
...
<?php
 include_once("form_evolucao_odontologica_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_odontologica']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_odontologica']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_evolucao_odontologica'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_evolucao_odontologica'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_odontologica']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_odontologica']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_odontologica']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_odontologica']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_odontologica']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_odontologica']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_odontologica']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_odontologica']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_anotacao_label" id="hidden_field_label_id_anotacao" style="<?php echo $sStyleHidden_id_anotacao; ?>"><span id="id_label_id_anotacao"><?php echo $this->nm_new_label['id_anotacao']; ?></span></TD>
    <TD class="scFormDataOdd css_id_anotacao_line" id="hidden_field_data_id_anotacao" style="<?php echo $sStyleHidden_id_anotacao; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_anotacao_line" style="vertical-align: top;padding: 0px"><span id="id_read_on_id_anotacao" class="css_id_anotacao_line" style="<?php echo $sStyleReadLab_id_anotacao; ?>"><?php echo $this->form_encode_input($this->id_anotacao); ?></span><span id="id_read_off_id_anotacao" style="<?php echo $sStyleReadInp_id_anotacao; ?>"><input type="hidden" name="id_anotacao" value="<?php echo $this->form_encode_input($id_anotacao) . "\">"?><span id="id_ajax_label_id_anotacao"><?php echo nl2br($id_anotacao); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_texto_line" id="hidden_field_data_texto" style="<?php echo $sStyleHidden_texto; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_texto_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_data_cadastro_label" id="hidden_field_label_data_cadastro" style="<?php echo $sStyleHidden_data_cadastro; ?>"><span id="id_label_data_cadastro"><?php echo $this->nm_new_label['data_cadastro']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_odontologica']['php_cmp_required']['data_cadastro']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_odontologica']['php_cmp_required']['data_cadastro'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipo_anotacao_label" id="hidden_field_label_tipo_anotacao" style="<?php echo $sStyleHidden_tipo_anotacao; ?>"><span id="id_label_tipo_anotacao"><?php echo $this->nm_new_label['tipo_anotacao']; ?></span></TD>
    <TD class="scFormDataOdd css_tipo_anotacao_line" id="hidden_field_data_tipo_anotacao" style="<?php echo $sStyleHidden_tipo_anotacao; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipo_anotacao_line" style="vertical-align: top;padding: 0px">
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_odontologica']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_evolucao_odontologica");
 parent.scAjaxDetailHeight("form_evolucao_odontologica", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
