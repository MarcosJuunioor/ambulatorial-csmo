...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_servidor_saude/form_servidor_saude_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_servidor_saude_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_servidor_saude_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['recarga'];
}
?>
...
<?php
 include_once("form_servidor_saude_mob_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_servidor_saude_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_servidor_saude_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['fast_search'][2] : "";
?> 
...
<?php echo nmButtonOutput($this->arr_buttons, "bincluir", "nm_atualiza ('incluir');", "nm_atualiza ('incluir');", "sc_b_ins_t", "", "Cadastrar", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "group_2_t");?>
  </div>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
   if (!isset($this->nmgp_cmp_hidden['data_cadastro']))
   {
       $this->nmgp_cmp_hidden['data_cadastro'] = 'off';
   }
   if (!isset($this->nmgp_cmp_hidden['token']))
   {
       $this->nmgp_cmp_hidden['token'] = 'off';
   }
?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['Lookup_cargo'][] = 'assistente_de_dentista'; ?>
 <option value="dentista" <?php  if ($this->cargo == "dentista") { echo " selected" ;} ?>>Dentista</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['Lookup_cargo'][] = 'dentista'; ?>
 <option value="enfermeiro" <?php  if ($this->cargo == "enfermeiro") { echo " selected" ;} ?>>Enfermeiro(a)</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['Lookup_cargo'][] = 'enfermeiro'; ?>
 <option value="tecnico" <?php  if ($this->cargo == "tecnico") { echo " selected" ;} ?><?php  if (empty($this->cargo)) { echo " selected" ;} ?>>Técnico(a) em enfermagem</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['Lookup_cargo'][] = 'tecnico'; ?>
 <option value="medico" <?php  if ($this->cargo == "medico") { echo " selected" ;} ?>>Médico(a)</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['Lookup_cargo'][] = 'medico'; ?>
 <option value="recepcionista" <?php  if ($this->cargo == "recepcionista") { echo " selected" ;} ?>>Recepcionista</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['Lookup_cargo'][] = 'recepcionista'; ?>
 <option value="gestor" <?php  if ($this->cargo == "gestor") { echo " selected" ;} ?>>Gestor</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['Lookup_cargo'][] = 'gestor'; ?>
 <option value="gestor_crm" <?php  if ($this->cargo == "gestor_crm") { echo " selected" ;} ?>>Gestor c/ CRM</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['Lookup_cargo'][] = 'gestor_crm'; ?>
 <option value="gestor_cro" <?php  if ($this->cargo == "gestor_cro") { echo " selected" ;} ?>>Gestor c/ CRO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['Lookup_cargo'][] = 'gestor_cro'; ?>
 <option value="gestor_coren" <?php  if ($this->cargo == "gestor_coren") { echo " selected" ;} ?>>Gestor c/ COREN</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['Lookup_cargo'][] = 'gestor_coren'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_data_nascimento_line" id="hidden_field_data_data_nascimento" style="<?php echo $sStyleHidden_data_nascimento; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_data_nascimento_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_data_nascimento_label"><span id="id_label_data_nascimento"><?php echo $this->nm_new_label['data_nascimento']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['php_cmp_required']['data_nascimento']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['php_cmp_required']['data_nascimento'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_siape_line" id="hidden_field_data_siape" style="<?php echo $sStyleHidden_siape; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_siape_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_siape_label"><span id="id_label_siape"><?php echo $this->nm_new_label['siape']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['php_cmp_required']['siape']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['php_cmp_required']['siape'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<span id="id_read_on_login" class="sc-ui-readonly-login css_login_line" style="<?php echo $sStyleReadLab_login; ?>"><?php echo $this->form_encode_input($this->login); ?></span><span id="id_read_off_login" style="white-space: nowrap;<?php echo $sStyleReadInp_login; ?>">
 ...
 size=10 maxlength=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '<?php echo $this->allowedCharsCharset("abcdefghijklmnopqrstuvwxyz0123456789") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_senha_line" id="hidden_field_data_senha" style="<?php echo $sStyleHidden_senha; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_senha_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_senha_label"><span id="id_label_senha"><?php echo $this->nm_new_label['senha']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['php_cmp_required']['senha']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['php_cmp_required']['senha'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_token_line" id="hidden_field_data_token" style="<?php echo $sStyleHidden_token; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_token_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_token_label"><span id="id_label_token"><?php echo $this->nm_new_label['token']; ?></span></span><br>
...
<?php } else { ?>
<span id="id_read_on_token" class="sc-ui-readonly-token css_token_line" style="<?php echo $sStyleReadLab_token; ?>"><?php echo $this->form_encode_input($this->token); ?></span><span id="id_read_off_token" style="white-space: nowrap;<?php echo $sStyleReadInp_token; ?>">
 ...
 size=10 maxlength=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '<?php echo $this->allowedCharsCharset("abcdefghijklmnopqrstuvwxyz0123456789") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_token_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_token_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['mostra_cab'] != "N"))
  {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_servidor_saude_mob");
 parent.scAjaxDetailHeight("form_servidor_saude_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
