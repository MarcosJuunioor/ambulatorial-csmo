...
<?php
include_once("form_servidor_saude_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_servidor_saude_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['recarga'];
}
?>
...
<?php
 include_once("form_servidor_saude_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_servidor_saude'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_servidor_saude'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['Lookup_cargo'][] = 'assistente_de_dentista'; ?>
 <option value="dentista" <?php  if ($this->cargo == "dentista") { echo " selected" ;} ?>>Dentista</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['Lookup_cargo'][] = 'dentista'; ?>
 <option value="enfermeiro" <?php  if ($this->cargo == "enfermeiro") { echo " selected" ;} ?>>Enfermeiro(a)</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['Lookup_cargo'][] = 'enfermeiro'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['Lookup_cargo'][] = 'tecnico'; ?>
 <option value="medico" <?php  if ($this->cargo == "medico") { echo " selected" ;} ?>>Médico(a)</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['Lookup_cargo'][] = 'medico'; ?>
 <option value="recepcionista" <?php  if ($this->cargo == "recepcionista") { echo " selected" ;} ?>>Recepcionista</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['Lookup_cargo'][] = 'recepcionista'; ?>
 <option value="gestor" <?php  if ($this->cargo == "gestor") { echo " selected" ;} ?>>Gestor</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['Lookup_cargo'][] = 'gestor'; ?>
 <option value="gestor_crm" <?php  if ($this->cargo == "gestor_crm") { echo " selected" ;} ?>>Gestor c/ CRM</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['Lookup_cargo'][] = 'gestor_crm'; ?>
 <option value="gestor_cro" <?php  if ($this->cargo == "gestor_cro") { echo " selected" ;} ?>>Gestor c/ CRO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['Lookup_cargo'][] = 'gestor_cro'; ?>
 <option value="gestor_coren" <?php  if ($this->cargo == "gestor_coren") { echo " selected" ;} ?>>Gestor c/ COREN</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['Lookup_cargo'][] = 'gestor_coren'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_data_nascimento_label" id="hidden_field_label_data_nascimento" style="<?php echo $sStyleHidden_data_nascimento; ?>"><span id="id_label_data_nascimento"><?php echo $this->nm_new_label['data_nascimento']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['php_cmp_required']['data_nascimento']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['php_cmp_required']['data_nascimento'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_siape_label" id="hidden_field_label_siape" style="<?php echo $sStyleHidden_siape; ?>"><span id="id_label_siape"><?php echo $this->nm_new_label['siape']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['php_cmp_required']['siape']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['php_cmp_required']['siape'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_login_label" id="hidden_field_label_login" style="<?php echo $sStyleHidden_login; ?>"><span id="id_label_login"><?php echo $this->nm_new_label['login']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['php_cmp_required']['login']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['php_cmp_required']['login'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_senha_label" id="hidden_field_label_senha" style="<?php echo $sStyleHidden_senha; ?>"><span id="id_label_senha"><?php echo $this->nm_new_label['senha']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['php_cmp_required']['senha']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['php_cmp_required']['senha'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_email_label" id="hidden_field_label_email" style="<?php echo $sStyleHidden_email; ?>"><span id="id_label_email"><?php echo $this->nm_new_label['email']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['php_cmp_required']['email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['php_cmp_required']['email'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_servidor_saude");
 parent.scAjaxDetailHeight("form_servidor_saude", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
