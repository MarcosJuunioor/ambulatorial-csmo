...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_paciente_atualizacao/form_paciente_atualizacao_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_paciente_atualizacao_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_paciente_atualizacao_jquery.php');
 ...
 function toggleBlock(e) {
  ...
  if (show_block[block_id]) {
    if ("hidden_bloco_0" == block_id) {
      scAjaxDetailHeight("form_visitante_atualizacao", "160");
      scAjaxDetailHeight("form_aluno_atualizacao", "240");
      scAjaxDetailHeight("form_servidor_atualizacao", "210");
      scAjaxDetailHeight("form_servidor_terceirizado_atualizacao", "180");
    }
  }
 }
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['recarga'];
}
?>
...
<?php
 include_once("form_paciente_atualizacao_js0.php");
?>
<script type="text/javascript" src="<?php  echo $this->Ini->path_js . "/nm_rpc.js" ?>"> 
</script> 
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_paciente_atualizacao'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_paciente_atualizacao'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nome_paciente_label" id="hidden_field_label_nome_paciente" style="<?php echo $sStyleHidden_nome_paciente; ?>"><span id="id_label_nome_paciente"><?php echo $this->nm_new_label['nome_paciente']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['php_cmp_required']['nome_paciente']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['php_cmp_required']['nome_paciente'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_nome_paciente_line" id="hidden_field_data_nome_paciente" style="<?php echo $sStyleHidden_nome_paciente; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nome_paciente_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cep_label" id="hidden_field_label_cep" style="<?php echo $sStyleHidden_cep; ?>"><span id="id_label_cep"><?php echo $this->nm_new_label['cep']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['php_cmp_required']['cep']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['php_cmp_required']['cep'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tipo_paciente_line" id="hidden_field_data_tipo_paciente" style="<?php echo $sStyleHidden_tipo_paciente; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipo_paciente_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['Lookup_tipo_paciente'][] = 'aluno'; ?>
 <option value="servidor" <?php  if ($this->tipo_paciente == "servidor") { echo " selected" ;} ?>>Servidor</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['Lookup_tipo_paciente'][] = 'servidor'; ?>
 <option value="terceirizado" <?php  if ($this->tipo_paciente == "terceirizado") { echo " selected" ;} ?>>Terceirizado</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['Lookup_tipo_paciente'][] = 'terceirizado'; ?>
 <option value="visitante" <?php  if ($this->tipo_paciente == "visitante") { echo " selected" ;} ?>>Visitante</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['Lookup_tipo_paciente'][] = 'visitante'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_telefone_contato_line" id="hidden_field_data_telefone_contato" style="<?php echo $sStyleHidden_telefone_contato; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_telefone_contato_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_data_nascimento_label" id="hidden_field_label_data_nascimento" style="<?php echo $sStyleHidden_data_nascimento; ?>"><span id="id_label_data_nascimento"><?php echo $this->nm_new_label['data_nascimento']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['php_cmp_required']['data_nascimento']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['php_cmp_required']['data_nascimento'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_contato_emergencial_line" id="hidden_field_data_contato_emergencial" style="<?php echo $sStyleHidden_contato_emergencial; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_contato_emergencial_line" style="vertical-align: top;padding: 0px">
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['visitante'] = "Dados Específicos";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_visitante_label" id="hidden_field_label_visitante" style="<?php echo $sStyleHidden_visitante; ?>"><span id="id_label_visitante"><?php echo $this->nm_new_label['visitante']; ?></span></TD>
    <TD class="scFormDataOdd css_visitante_line" id="hidden_field_data_visitante" style="<?php echo $sStyleHidden_visitante; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td width="100%" class="scFormDataFontOdd css_visitante_line" style="vertical-align: top;padding: 0px">
<?php
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_visitante_atualizacao']['embutida_proc']  = false;
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_visitante_atualizacao']['embutida_form']  = true;
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_visitante_atualizacao']['embutida_call']  = true;
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_visitante_atualizacao']['embutida_multi'] = false;
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_visitante_atualizacao']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_visitante_atualizacao']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_visitante_atualizacao']['embutida_liga_form_delete'] = 'off';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_visitante_atualizacao']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_visitante_atualizacao']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_visitante_atualizacao']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_visitante_atualizacao']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_visitante_atualizacao']['embutida_liga_tp_pag'] = 'parcial';
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_paciente_atualizacao_empty.htm' : $this->Ini->link_form_visitante_atualizacao_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=160');
?>
<iframe border="0" id="nmsc_iframe_liga_form_visitante_atualizacao"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="160" width="250" name="nmsc_iframe_liga_form_visitante_atualizacao"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['aluno'] = "Dados Específicos";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_aluno_label" id="hidden_field_label_aluno" style="<?php echo $sStyleHidden_aluno; ?>"><span id="id_label_aluno"><?php echo $this->nm_new_label['aluno']; ?></span></TD>
    <TD class="scFormDataOdd css_aluno_line" id="hidden_field_data_aluno" style="<?php echo $sStyleHidden_aluno; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td width="100%" class="scFormDataFontOdd css_aluno_line" style="vertical-align: top;padding: 0px">
<?php
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao']['embutida_proc']  = false;
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao']['embutida_form']  = true;
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao']['embutida_call']  = true;
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao']['embutida_multi'] = false;
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao']['embutida_liga_form_delete'] = 'off';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao']['embutida_liga_tp_pag'] = 'parcial';
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_paciente_atualizacao_empty.htm' : $this->Ini->link_form_aluno_atualizacao_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=240');
?>
<iframe border="0" id="nmsc_iframe_liga_form_aluno_atualizacao"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="240" width="650" name="nmsc_iframe_liga_form_aluno_atualizacao"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['servidor'] = "Dados Específicos";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_servidor_line" id="hidden_field_data_servidor" style="<?php echo $sStyleHidden_servidor; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td width="100%" class="scFormDataFontOdd css_servidor_line" style="vertical-align: top;padding: 0px">
<?php
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_atualizacao']['embutida_proc']  = false;
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_atualizacao']['embutida_form']  = true;
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_atualizacao']['embutida_call']  = true;
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_atualizacao']['embutida_multi'] = false;
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_atualizacao']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_atualizacao']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_atualizacao']['embutida_liga_form_delete'] = 'off';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_atualizacao']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_atualizacao']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_atualizacao']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_atualizacao']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_atualizacao']['embutida_liga_tp_pag'] = 'parcial';
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_paciente_atualizacao_empty.htm' : $this->Ini->link_form_servidor_atualizacao_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=210');
?>
<iframe border="0" id="nmsc_iframe_liga_form_servidor_atualizacao"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="210" width="400" name="nmsc_iframe_liga_form_servidor_atualizacao"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['terceirizado']))
    {
        $this->nm_new_label['terceirizado'] = "Dados Específicos";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   $sStyleHidden_terceirizado = '';
   if (isset($this->nmgp_cmp_hidden['terceirizado']) && $this->nmgp_cmp_hidden['terceirizado'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['terceirizado']);
       $sStyleHidden_terceirizado = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_terceirizado = 'display: none;';
   $sStyleReadInp_terceirizado = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['terceirizado']) && $this->nmgp_cmp_readonly['terceirizado'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['terceirizado']);
       $sStyleReadLab_terceirizado = '';
       $sStyleReadInp_terceirizado = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['terceirizado']) && $this->nmgp_cmp_hidden['terceirizado'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="terceirizado" value="<?php echo $this->form_encode_input($terceirizado) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_terceirizado_label" id="hidden_field_label_terceirizado" style="<?php echo $sStyleHidden_terceirizado; ?>"><span id="id_label_terceirizado"><?php echo $this->nm_new_label['terceirizado']; ?></span></TD>
    <TD class="scFormDataOdd css_terceirizado_line" id="hidden_field_data_terceirizado" style="<?php echo $sStyleHidden_terceirizado; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td width="100%" class="scFormDataFontOdd css_terceirizado_line" style="vertical-align: top;padding: 0px">
<?php
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_terceirizado_atualizacao']['embutida_proc']  = false;
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_terceirizado_atualizacao']['embutida_form']  = true;
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_terceirizado_atualizacao']['embutida_call']  = true;
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_terceirizado_atualizacao']['embutida_multi'] = false;
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_terceirizado_atualizacao']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_terceirizado_atualizacao']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_terceirizado_atualizacao']['embutida_liga_form_delete'] = 'off';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_terceirizado_atualizacao']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_terceirizado_atualizacao']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_terceirizado_atualizacao']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_terceirizado_atualizacao']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_terceirizado_atualizacao']['embutida_liga_tp_pag'] = 'parcial';
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_paciente_atualizacao_empty.htm' : $this->Ini->link_form_servidor_terceirizado_atualizacao_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=180');
?>
<iframe border="0" id="nmsc_iframe_liga_form_servidor_terceirizado_atualizacao"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="180" width="500" name="nmsc_iframe_liga_form_servidor_terceirizado_atualizacao"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_terceirizado_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_terceirizado_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_flag_line" id="hidden_field_data_flag" style="<?php echo $sStyleHidden_flag; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_flag_line" style="vertical-align: top;padding: 0px">
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_paciente_atualizacao");
 parent.scAjaxDetailHeight("form_paciente_atualizacao", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
