...
<?php
include_once("form_paciente_atualizacao_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_paciente_atualizacao_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['recarga'];
}
?>
...
<?php
 include_once("form_paciente_atualizacao_mob_js0.php");
?>
<script type="text/javascript" src="<?php  echo $this->Ini->path_js . "/nm_rpc.js" ?>"> 
</script> 
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_paciente_atualizacao_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_paciente_atualizacao_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nome_paciente_line" id="hidden_field_data_nome_paciente" style="<?php echo $sStyleHidden_nome_paciente; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nome_paciente_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_nome_paciente_label"><span id="id_label_nome_paciente"><?php echo $this->nm_new_label['nome_paciente']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['php_cmp_required']['nome_paciente']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['php_cmp_required']['nome_paciente'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<span id="id_read_on_cep" class="sc-ui-readonly-cep css_cep_line" style="<?php echo $sStyleReadLab_cep; ?>"><?php echo $this->form_encode_input($this->cep); ?></span><span id="id_read_off_cep" style="white-space: nowrap;<?php echo $sStyleReadInp_cep; ?>">
 ...
 size=8 alt="{datatype: 'cep', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}">&nbsp;<?php echo nmButtonOutput($this->arr_buttons, "bzipcode", "tb_show('', '" . $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . SC_dir_app_name('form_paciente_atualizacao'). "/form_paciente_atualizacao_mob_cep.php?cep=' + document.F1.cep.value + '&form_origem=F1;CEP,cep;UF,estado;CIDADE,cidade;BAIRRO,bairro;RUA,rua&TB_iframe=true&height=220&width=350&modal=true', '')", "tb_show('', '" . $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . SC_dir_app_name('form_paciente_atualizacao'). "/form_paciente_atualizacao_mob_cep.php?cep=' + document.F1.cep.value + '&form_origem=F1;CEP,cep;UF,estado;CIDADE,cidade;BAIRRO,bairro;RUA,rua&TB_iframe=true&height=220&width=350&modal=true', '')", "cep_cep", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['Lookup_tipo_paciente'][] = 'aluno'; ?>
 <option value="servidor" <?php  if ($this->tipo_paciente == "servidor") { echo " selected" ;} ?>>Servidor</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['Lookup_tipo_paciente'][] = 'servidor'; ?>
 <option value="terceirizado" <?php  if ($this->tipo_paciente == "terceirizado") { echo " selected" ;} ?>>Terceirizado</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['Lookup_tipo_paciente'][] = 'terceirizado'; ?>
 <option value="visitante" <?php  if ($this->tipo_paciente == "visitante") { echo " selected" ;} ?>>Visitante</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['Lookup_tipo_paciente'][] = 'visitante'; ?>
 </select></span>
</span><?php  }?>
...
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_paciente_atualizacao_mob_empty.htm' : $this->Ini->link_form_visitante_atualizacao_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=160');
?>
...
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_paciente_atualizacao_mob_empty.htm' : $this->Ini->link_form_aluno_atualizacao_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=240');
?>
...
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_paciente_atualizacao_mob_empty.htm' : $this->Ini->link_form_servidor_atualizacao_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=210');
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_terceirizado_line" id="hidden_field_data_terceirizado" style="<?php echo $sStyleHidden_terceirizado; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td width="100%" class="scFormDataFontOdd css_terceirizado_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_terceirizado_label"><span id="id_label_terceirizado"><?php echo $this->nm_new_label['terceirizado']; ?></span></span><br>
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_paciente_atualizacao_mob_empty.htm' : $this->Ini->link_form_servidor_terceirizado_atualizacao_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=180');
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_flag_line" id="hidden_field_data_flag" style="<?php echo $sStyleHidden_flag; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_flag_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_flag_label"><span id="id_label_flag"><?php echo $this->nm_new_label['flag']; ?></span></span><br>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['mostra_cab'] != "N"))
  {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_atualizacao_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_paciente_atualizacao_mob");
 parent.scAjaxDetailHeight("form_paciente_atualizacao_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
