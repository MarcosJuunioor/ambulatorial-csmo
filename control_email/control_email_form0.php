...
<?php
include_once("control_email_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_email_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_email']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_email']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_email']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_email']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_email']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_email']['recarga'];
}
?>
...
<?php
 include_once("control_email_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_email'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_email'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_email']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_email']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  if ($this->nmgp_form_empty)
  {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_email']['empty_filter'] = true;
       }
  }
  else
  {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_email']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("control_email");
 parent.scAjaxDetailHeight("control_email", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
