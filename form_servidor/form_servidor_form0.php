...
<?php
include_once("form_servidor_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_servidor_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor']['recarga'];
}
?>
...
<?php
 include_once("form_servidor_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_servidor'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_servidor'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_siape_label" id="hidden_field_label_siape" style="<?php echo $sStyleHidden_siape; ?>"><span id="id_label_siape"><?php echo $this->nm_new_label['siape']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor']['php_cmp_required']['siape']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor']['php_cmp_required']['siape'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipo_vinculo_label" id="hidden_field_label_tipo_vinculo" style="<?php echo $sStyleHidden_tipo_vinculo; ?>"><span id="id_label_tipo_vinculo"><?php echo $this->nm_new_label['tipo_vinculo']; ?></span></TD>
    <TD class="scFormDataOdd css_tipo_vinculo_line" id="hidden_field_data_tipo_vinculo" style="<?php echo $sStyleHidden_tipo_vinculo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipo_vinculo_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor']['Lookup_tipo_vinculo'][] = 'efetivo'; ?>
 <option value="substituto" <?php  if ($this->tipo_vinculo == "substituto") { echo " selected" ;} ?>>substituto(a)</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor']['Lookup_tipo_vinculo'][] = 'substituto'; ?>
 </select></span>
</span><?php  }?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor']['run_iframe'] != "R")
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_servidor");
 parent.scAjaxDetailHeight("form_servidor", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
