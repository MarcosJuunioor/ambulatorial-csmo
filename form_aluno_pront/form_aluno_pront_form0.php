...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Administração'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Agroindústria'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Agropecuária'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Análise e Desenvolvimento de Sistemas'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Automação Industrial'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Auxiliar de Técnico em Agropecuária'; ?>
 <option value="Computação Gráfica" <?php  if ($this->curso == "Computação Gráfica") { echo " selected" ;} ?>>Computação Gráfica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Computação Gráfica'; ?>
 <option value="Construção Naval" <?php  if ($this->curso == "Construção Naval") { echo " selected" ;} ?>>Construção Naval</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Construção Naval'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Desenvolvimento, Inovação e Tecnologias Emergentes'; ?>
 <option value="Design Gráfico" <?php  if ($this->curso == "Design Gráfico") { echo " selected" ;} ?>>Design Gráfico</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Design Gráfico'; ?>
 <option value="Edificações" <?php  if ($this->curso == "Edificações") { echo " selected" ;} ?>>Edificações</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Edificações'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Educação Profissional e Tecnológica (mestrado) '; ?>
 <option value="Eletroeletrônica" <?php  if ($this->curso == "Eletroeletrônica") { echo " selected" ;} ?>>Eletroeletrônica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Eletroeletrônica'; ?>
 <option value="Eletrônica" <?php  if ($this->curso == "Eletrônica") { echo " selected" ;} ?>>Eletrônica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Eletrônica'; ?>
 <option value="Eletrotécnica" <?php  if ($this->curso == "Eletrotécnica") { echo " selected" ;} ?>>Eletrotécnica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Eletrotécnica'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Engenharia Elétrica'; ?>
 <option value="Engenharia Mecânica" <?php  if ($this->curso == "Engenharia Mecânica") { echo " selected" ;} ?>>Engenharia Mecânica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Engenharia Mecânica'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Engenharia de Segurança do Trabalho'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Ensino da Matemática para o Ensino Médio'; ?>
 <option value="Ensino de Ciências" <?php  if ($this->curso == "Ensino de Ciências") { echo " selected" ;} ?>>Ensino de Ciências</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Ensino de Ciências'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Gestão Ambiental (superior)'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Gestão Ambiental (mestrado)'; ?>
 <option value="Gestão da Qualidade" <?php  if ($this->curso == "Gestão da Qualidade") { echo " selected" ;} ?>>Gestão da Qualidade</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Gestão da Qualidade'; ?>
 <option value="Gestão de Turismo" <?php  if ($this->curso == "Gestão de Turismo") { echo " selected" ;} ?>>Gestão de Turismo</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Gestão de Turismo'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Gestão e Qualidade e Tecnologia da Informação e Comunicação'; ?>
 <option value="Gestão Pública" <?php  if ($this->curso == "Gestão Pública") { echo " selected" ;} ?>>Gestão Pública</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Gestão Pública'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Informática'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Informática para Internet'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Inovação e Desenvolvimento de Softwares para a Web e Dispositivos Móveis'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Licenciatura em Física'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Licenciatura em Matemática'; ?>
 <option value="Licenciatura em Música" <?php  if ($this->curso == "Licenciatura em Música") { echo " selected" ;} ?>>Licenciatura em Música</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Licenciatura em Música'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Licenciatura em Química'; ?>
 <option value="Logística" <?php  if ($this->curso == "Logística") { echo " selected" ;} ?>>Logística</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Logística'; ?>
 <option value="Manutenção Automotiva" <?php  if ($this->curso == "Manutenção Automotiva") { echo " selected" ;} ?>>Manutenção Automotiva</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Manutenção Automotiva'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Manutenção e Suporte em Informática'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Matemática (especialização)'; ?>
 <option value="Mecânica" <?php  if ($this->curso == "Mecânica") { echo " selected" ;} ?>>Mecânica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Mecânica'; ?>
 <option value="Mecatrônica" <?php  if ($this->curso == "Mecatrônica") { echo " selected" ;} ?>>Mecatrônica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Mecatrônica'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Operador de Processamento de Frutas e Hortaliças'; ?>
 <option value="Petroquímica" <?php  if ($this->curso == "Petroquímica") { echo " selected" ;} ?>>Petroquímica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Petroquímica'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Química'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Refrigeração e Climatização'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Segurança do Trabalho'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Sistemas de Energia Renovável'; ?>
 <option value="Telecomunicações" <?php  if ($this->curso == "Telecomunicações") { echo " selected" ;} ?>>Telecomunicações</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pront']['Lookup_curso'][] = 'Telecomunicações'; ?>
