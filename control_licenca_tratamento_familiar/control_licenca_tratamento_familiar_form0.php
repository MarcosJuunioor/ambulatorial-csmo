...
<?php
include_once("control_licenca_tratamento_familiar_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_licenca_tratamento_familiar_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-nome", elem).focus(function() {
   ...
   source: function (request, response) {
    $.ajax({
     url: "control_licenca_tratamento_familiar.php",
     dataType: "json",
     data: {
      term: request.term,
   ...
   change: function (event, ui) {
    var sId = $(this).attr("id").substr(6), sRow = 'nome' != sId ? sId.substr(4) : '';
    if ("" == $(this).val()) {
     do_ajax_control_licenca_tratamento_familiar_event_nome_onchange(sRow);
    }
   },
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_familiar']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_familiar']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_familiar']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_familiar']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_familiar']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_familiar']['recarga'];
}
?>
...
<?php
 include_once("control_licenca_tratamento_familiar_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_licenca_tratamento_familiar'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_licenca_tratamento_familiar'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_familiar']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_familiar']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  if ($this->nmgp_form_empty)
  {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_familiar']['empty_filter'] = true;
       }
  }
  else
  {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_orgao_label" id="hidden_field_label_orgao" style="<?php echo $sStyleHidden_orgao; ?>"><span id="id_label_orgao"><?php echo $this->nm_new_label['orgao']; ?></span></TD>
    <TD class="scFormDataOdd css_orgao_line" id="hidden_field_data_orgao" style="<?php echo $sStyleHidden_orgao; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_data_inicial_label" id="hidden_field_label_data_inicial" style="<?php echo $sStyleHidden_data_inicial; ?>"><span id="id_label_data_inicial"><?php echo $this->nm_new_label['data_inicial']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_data_hoje_label" id="hidden_field_label_data_hoje" style="<?php echo $sStyleHidden_data_hoje; ?>"><span id="id_label_data_hoje"><?php echo $this->nm_new_label['data_hoje']; ?></span></TD>
    <TD class="scFormDataOdd css_data_hoje_line" id="hidden_field_data_data_hoje" style="<?php echo $sStyleHidden_data_hoje; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_familiar_label" id="hidden_field_label_familiar" style="<?php echo $sStyleHidden_familiar; ?>"><span id="id_label_familiar"><?php echo $this->nm_new_label['familiar']; ?></span></TD>
    <TD class="scFormDataOdd css_familiar_line" id="hidden_field_data_familiar" style="<?php echo $sStyleHidden_familiar; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_parentesco_label" id="hidden_field_label_parentesco" style="<?php echo $sStyleHidden_parentesco; ?>"><span id="id_label_parentesco"><?php echo $this->nm_new_label['parentesco']; ?></span></TD>
    <TD class="scFormDataOdd css_parentesco_line" id="hidden_field_data_parentesco" style="<?php echo $sStyleHidden_parentesco; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cid_label" id="hidden_field_label_cid" style="<?php echo $sStyleHidden_cid; ?>"><span id="id_label_cid"><?php echo $this->nm_new_label['cid']; ?></span></TD>
    <TD class="scFormDataOdd css_cid_line" id="hidden_field_data_cid" style="<?php echo $sStyleHidden_cid; ?>">
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_familiar']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("control_licenca_tratamento_familiar");
 parent.scAjaxDetailHeight("control_licenca_tratamento_familiar", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
