...
<?php
include_once("form_aluno_atualizacao_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_aluno_atualizacao_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['recarga'];
}
?>
...
<?php
 include_once("form_aluno_atualizacao_mob_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_aluno_atualizacao_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_aluno_atualizacao_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_matricula_line" id="hidden_field_data_matricula" style="<?php echo $sStyleHidden_matricula; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_matricula_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_matricula_label"><span id="id_label_matricula"><?php echo $this->nm_new_label['matricula']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['php_cmp_required']['matricula']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['php_cmp_required']['matricula'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nome_responsavel_line" id="hidden_field_data_nome_responsavel" style="<?php echo $sStyleHidden_nome_responsavel; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nome_responsavel_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_nome_responsavel_label"><span id="id_label_nome_responsavel"><?php echo $this->nm_new_label['nome_responsavel']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_campus_line" id="hidden_field_data_id_campus" style="<?php echo $sStyleHidden_id_campus; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_campus_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_campus_label"><span id="id_label_id_campus"><?php echo $this->nm_new_label['id_campus']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_modalidade_curso_line" id="hidden_field_data_modalidade_curso" style="<?php echo $sStyleHidden_modalidade_curso; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_modalidade_curso_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_modalidade_curso_label"><span id="id_label_modalidade_curso"><?php echo $this->nm_new_label['modalidade_curso']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_modalidade_curso'][] = 'tecnico'; ?>
 <option value="superior" <?php  if ($this->modalidade_curso == "superior") { echo " selected" ;} ?>>Superior</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_modalidade_curso'][] = 'superior'; ?>
 <option value="posgraduacao" <?php  if ($this->modalidade_curso == "posgraduacao") { echo " selected" ;} ?>>Pós-Graduação</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_modalidade_curso'][] = 'posgraduacao'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Administração'; ?>
 <option value="Agricultor Familiar" <?php  if ($this->curso == "Agricultor Familiar") { echo " selected" ;} ?>>Agricultor Familiar</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Agricultor Familiar'; ?>
 <option value="Agricultura" <?php  if ($this->curso == "Agricultura") { echo " selected" ;} ?>>Agricultura</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Agricultura'; ?>
 <option value="Agroecologia" <?php  if ($this->curso == "Agroecologia") { echo " selected" ;} ?>>Agroecologia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Agroecologia'; ?>
 <option value="Agroindústria" <?php  if ($this->curso == "Agroindústria") { echo " selected" ;} ?>>Agroindústria</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Agroindústria'; ?>
 <option value="Agronomia" <?php  if ($this->curso == "Agronomia") { echo " selected" ;} ?>>Agronomia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Agronomia'; ?>
 <option value="Agropecuária" <?php  if ($this->curso == "Agropecuária") { echo " selected" ;} ?>>Agropecuária</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Agropecuária'; ?>
 <option value="Alimentos" <?php  if ($this->curso == "Alimentos") { echo " selected" ;} ?>>Alimentos</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Alimentos'; ?>
 <option value="Almoxarife" <?php  if ($this->curso == "Almoxarife") { echo " selected" ;} ?>>Almoxarife</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Almoxarife'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Análise e Desenvolvimento de Sistemas'; ?>
 <option value="Artes Visuais" <?php  if ($this->curso == "Artes Visuais") { echo " selected" ;} ?>>Artes Visuais</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Artes Visuais'; ?>
 <option value="Automação Industrial" <?php  if ($this->curso == "Automação Industrial") { echo " selected" ;} ?>>Automação Industrial</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Automação Industrial'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Auxiliar de Técnico em Agropecuária'; ?>
 <option value="Computação Gráfica" <?php  if ($this->curso == "Computação Gráfica") { echo " selected" ;} ?>>Computação Gráfica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Computação Gráfica'; ?>
 <option value="Construção Naval" <?php  if ($this->curso == "Construção Naval") { echo " selected" ;} ?>>Construção Naval</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Construção Naval'; ?>
 <option value="Cozinha" <?php  if ($this->curso == "Cozinha") { echo " selected" ;} ?>>Cozinha</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Cozinha'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Desenvolvimento, Inovação e Tecnologias Emergentes'; ?>
 <option value="Design Gráfico" <?php  if ($this->curso == "Design Gráfico") { echo " selected" ;} ?>>Design Gráfico</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Design Gráfico'; ?>
 <option value="Edificações" <?php  if ($this->curso == "Edificações") { echo " selected" ;} ?>>Edificações</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Edificações'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Educação Profissional e Tecnológica (mestrado) '; ?>
 <option value="Eletroeletrônica" <?php  if ($this->curso == "Eletroeletrônica") { echo " selected" ;} ?>>Eletroeletrônica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Eletroeletrônica'; ?>
 <option value="Eletrônica" <?php  if ($this->curso == "Eletrônica") { echo " selected" ;} ?>>Eletrônica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Eletrônica'; ?>
 <option value="Eletrotécnica" <?php  if ($this->curso == "Eletrotécnica") { echo " selected" ;} ?>>Eletrotécnica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Eletrotécnica'; ?>
 <option value="Enfermagem" <?php  if ($this->curso == "Enfermagem") { echo " selected" ;} ?>>Enfermagem</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Enfermagem'; ?>
 <option value="Enfermagem (superior)" <?php  if ($this->curso == "Enfermagem (superior)") { echo " selected" ;} ?>>Enfermagem (superior)</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Enfermagem (superior)'; ?>
 <option value="Engenharia Civil" <?php  if ($this->curso == "Engenharia Civil") { echo " selected" ;} ?>>Engenharia Civil</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Engenharia Civil'; ?>
 <option value="Engenharia Elétrica" <?php  if ($this->curso == "Engenharia Elétrica") { echo " selected" ;} ?>>Engenharia Elétrica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Engenharia Elétrica'; ?>
 <option value="Engenharia Mecânica" <?php  if ($this->curso == "Engenharia Mecânica") { echo " selected" ;} ?>>Engenharia Mecânica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Engenharia Mecânica'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Engenharia de Segurança do Trabalho'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Ensino da Matemática para o Ensino Médio'; ?>
 <option value="Ensino de Ciências" <?php  if ($this->curso == "Ensino de Ciências") { echo " selected" ;} ?>>Ensino de Ciências</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Ensino de Ciências'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Gestão Ambiental (superior)'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Gestão Ambiental (mestrado)'; ?>
 <option value="Gestão da Qualidade" <?php  if ($this->curso == "Gestão da Qualidade") { echo " selected" ;} ?>>Gestão da Qualidade</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Gestão da Qualidade'; ?>
 <option value="Gestão de Turismo" <?php  if ($this->curso == "Gestão de Turismo") { echo " selected" ;} ?>>Gestão de Turismo</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Gestão de Turismo'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Gestão e Qualidade e Tecnologia da Informação e Comunicação'; ?>
 <option value="Gestão Pública" <?php  if ($this->curso == "Gestão Pública") { echo " selected" ;} ?>>Gestão Pública</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Gestão Pública'; ?>
 <option value="Hospedagem" <?php  if ($this->curso == "Hospedagem") { echo " selected" ;} ?>>Hospedagem</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Hospedagem'; ?>
 <option value="Informática" <?php  if ($this->curso == "Informática") { echo " selected" ;} ?>>Informática</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Informática'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Informática para Internet'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Inovação e Desenvolvimento de Softwares para a Web e Dispositivos Móveis'; ?>
 <option value="Instrumento Musical" <?php  if ($this->curso == "Instrumento Musical") { echo " selected" ;} ?>>Instrumento Musical</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Instrumento Musical'; ?>
 <option value="Licenciatura em Física" <?php  if ($this->curso == "Licenciatura em Física") { echo " selected" ;} ?>>Licenciatura em Física</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Licenciatura em Física'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Licenciatura em Geografia'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Licenciatura em Matemática'; ?>
 <option value="Licenciatura em Música" <?php  if ($this->curso == "Licenciatura em Música") { echo " selected" ;} ?>>Licenciatura em Música</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Licenciatura em Música'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Licenciatura em Química'; ?>
 <option value="Logística" <?php  if ($this->curso == "Logística") { echo " selected" ;} ?>>Logística</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Logística'; ?>
 <option value="Manutenção Automotiva" <?php  if ($this->curso == "Manutenção Automotiva") { echo " selected" ;} ?>>Manutenção Automotiva</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Manutenção Automotiva'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Manutenção e Suporte em Informática'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Matemática (especialização)'; ?>
 <option value="Mecânica" <?php  if ($this->curso == "Mecânica") { echo " selected" ;} ?>>Mecânica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Mecânica'; ?>
 <option value="Mecatrônica" <?php  if ($this->curso == "Mecatrônica") { echo " selected" ;} ?>>Mecatrônica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Mecatrônica'; ?>
 <option value="Meio Ambiente" <?php  if ($this->curso == "Meio Ambiente") { echo " selected" ;} ?>>Meio Ambiente</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Meio Ambiente'; ?>
 <option value="Operador de Computador" <?php  if ($this->curso == "Operador de Computador") { echo " selected" ;} ?>>Operador de Computador</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Operador de Computador'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Operador de Processamento de Frutas e Hortaliças'; ?>
 <option value="Petroquímica" <?php  if ($this->curso == "Petroquímica") { echo " selected" ;} ?>>Petroquímica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Petroquímica'; ?>
 <option value="Qualidade" <?php  if ($this->curso == "Qualidade") { echo " selected" ;} ?>>Qualidade</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Qualidade'; ?>
 <option value="Química" <?php  if ($this->curso == "Química") { echo " selected" ;} ?>>Química</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Química'; ?>
 <option value="Radiologia" <?php  if ($this->curso == "Radiologia") { echo " selected" ;} ?>>Radiologia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Radiologia'; ?>
 <option value="Rede de Computadores" <?php  if ($this->curso == "Rede de Computadores") { echo " selected" ;} ?>>Rede de Computadores</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Rede de Computadores'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Refrigeração e Climatização'; ?>
 <option value="Saneamento" <?php  if ($this->curso == "Saneamento") { echo " selected" ;} ?>>Saneamento</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Saneamento'; ?>
 <option value="Segurança do Trabalho" <?php  if ($this->curso == "Segurança do Trabalho") { echo " selected" ;} ?>>Segurança do Trabalho</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Segurança do Trabalho'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Sistemas de Energia Renovável'; ?>
 <option value="Telecomunicações" <?php  if ($this->curso == "Telecomunicações") { echo " selected" ;} ?>>Telecomunicações</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Telecomunicações'; ?>
 <option value="Zootecnia" <?php  if ($this->curso == "Zootecnia") { echo " selected" ;} ?>>Zootecnia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['Lookup_curso'][] = 'Zootecnia'; ?>
 </select></span>
</span><?php  }?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_atualizacao_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_aluno_atualizacao_mob");
 parent.scAjaxDetailHeight("form_aluno_atualizacao_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
