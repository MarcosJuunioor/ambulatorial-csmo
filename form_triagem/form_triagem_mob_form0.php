...
<?php
include_once("form_triagem_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_triagem_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['recarga'];
}
?>
...
<?php
 include_once("form_triagem_mob_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_triagem_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_triagem_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOdd css_id_triagem_line" id="hidden_field_data_id_triagem" style="<?php echo $sStyleHidden_id_triagem; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_triagem_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_triagem_label"><span id="id_label_id_triagem"><?php echo $this->nm_new_label['id_triagem']; ?></span></span><br><span id="id_read_on_id_triagem" class="css_id_triagem_line" style="<?php echo $sStyleReadLab_id_triagem; ?>"><?php echo $this->form_encode_input($this->id_triagem); ?></span><span id="id_read_off_id_triagem" style="<?php echo $sStyleReadInp_id_triagem; ?>"><input type="hidden" name="id_triagem" value="<?php echo $this->form_encode_input($id_triagem) . "\">"?><span id="id_ajax_label_id_triagem"><?php echo nl2br($id_triagem); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_data_line" id="hidden_field_data_data" style="<?php echo $sStyleHidden_data; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_data_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_data_label"><span id="id_label_data"><?php echo $this->nm_new_label['data']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['php_cmp_required']['data']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['php_cmp_required']['data'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br><input type="hidden" name="data" value="<?php echo $this->form_encode_input($data); ?>"><span id="id_ajax_label_data"><?php echo nl2br($data); ?></span>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pa_line" id="hidden_field_data_pa" style="<?php echo $sStyleHidden_pa; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pa_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_pa_label"><span id="id_label_pa"><?php echo $this->nm_new_label['pa']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fc_line" id="hidden_field_data_fc" style="<?php echo $sStyleHidden_fc; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fc_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fc_label"><span id="id_label_fc"><?php echo $this->nm_new_label['fc']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fr_line" id="hidden_field_data_fr" style="<?php echo $sStyleHidden_fr; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fr_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fr_label"><span id="id_label_fr"><?php echo $this->nm_new_label['fr']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tc_line" id="hidden_field_data_tc" style="<?php echo $sStyleHidden_tc; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tc_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tc_label"><span id="id_label_tc"><?php echo $this->nm_new_label['tc']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_hgt_line" id="hidden_field_data_hgt" style="<?php echo $sStyleHidden_hgt; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_hgt_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_hgt_label"><span id="id_label_hgt"><?php echo $this->nm_new_label['hgt']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_peso_line" id="hidden_field_data_peso" style="<?php echo $sStyleHidden_peso; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_peso_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_peso_label"><span id="id_label_peso"><?php echo $this->nm_new_label['peso']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_altura_line" id="hidden_field_data_altura" style="<?php echo $sStyleHidden_altura; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_altura_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_altura_label"><span id="id_label_altura"><?php echo $this->nm_new_label['altura']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_coren_line" id="hidden_field_data_coren" style="<?php echo $sStyleHidden_coren; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_coren_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_coren_label"><span id="id_label_coren"><?php echo $this->nm_new_label['coren']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_alergia_line" id="hidden_field_data_alergia" style="<?php echo $sStyleHidden_alergia; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_alergia_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_alergia_label"><span id="id_label_alergia"><?php echo $this->nm_new_label['alergia']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['Lookup_alergia'][] = 'sim'; ?>
<?php  if ("sim" == $this->alergia)  { echo " checked" ;} ?>  onClick="do_ajax_form_triagem_mob_event_alergia_onclick();" >Sim</TD>
</TR>
<TR>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['Lookup_alergia'][] = 'nao'; ?>
<?php  if ("nao" == $this->alergia)  { echo " checked" ;} ?><?php  if (empty($this->alergia)) { echo " checked" ;} ?>  onClick="do_ajax_form_triagem_mob_event_alergia_onclick();" >Não</TD>
</TR></TABLE>
</div>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tipo_alergia_line" id="hidden_field_data_tipo_alergia" style="<?php echo $sStyleHidden_tipo_alergia; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipo_alergia_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tipo_alergia_label"><span id="id_label_tipo_alergia"><?php echo $this->nm_new_label['tipo_alergia']; ?></span></span><br>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_triagem_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_triagem_mob");
 parent.scAjaxDetailHeight("form_triagem_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
