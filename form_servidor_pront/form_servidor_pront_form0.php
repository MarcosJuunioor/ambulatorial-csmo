...
<?php
include_once("form_servidor_pront_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_servidor_pront_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_pront']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_pront']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_pront']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_pront']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_pront']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_pront']['recarga'];
}
?>
...
<?php
 include_once("form_servidor_pront_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_pront']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_pront']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_servidor_pront'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_servidor_pront'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_pront']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_pront']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_pront']['Lookup_tipo_vinculo'][] = 'efetivo'; ?>
 <option value="substituto" <?php  if ($this->tipo_vinculo == "substituto") { echo " selected" ;} ?>>substituto(a)</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_pront']['Lookup_tipo_vinculo'][] = 'substituto'; ?>
 </select></span>
</span><?php  }?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_pront']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_pront']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_pront']['run_iframe'] != "R")
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_pront']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_servidor_pront");
 parent.scAjaxDetailHeight("form_servidor_pront", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
