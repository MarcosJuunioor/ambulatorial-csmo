...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>control_licenca_tratamento/control_licenca_tratamento_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("control_licenca_tratamento_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_licenca_tratamento_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-nome", elem).focus(function() {
   ...
   source: function (request, response) {
    $.ajax({
     url: "control_licenca_tratamento.php",
     dataType: "json",
     data: {
      term: request.term,
   ...
   change: function (event, ui) {
    var sId = $(this).attr("id").substr(6), sRow = 'nome' != sId ? sId.substr(4) : '';
    if ("" == $(this).val()) {
     do_ajax_control_licenca_tratamento_event_nome_onchange(sRow);
    }
   },
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento']['recarga'];
}
?>
...
<?php
 include_once("control_licenca_tratamento_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_licenca_tratamento'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_licenca_tratamento'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento']['empty_filter'] = true;
       }
  }
  else
  {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("control_licenca_tratamento");
 parent.scAjaxDetailHeight("control_licenca_tratamento", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
