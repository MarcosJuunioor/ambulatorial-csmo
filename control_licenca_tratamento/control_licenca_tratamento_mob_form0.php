...
<?php
include_once("control_licenca_tratamento_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_licenca_tratamento_mob_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-nome", elem).focus(function() {
   ...
   source: function (request, response) {
    $.ajax({
     url: "control_licenca_tratamento_mob.php",
     dataType: "json",
     data: {
      term: request.term,
   ...
   change: function (event, ui) {
    var sId = $(this).attr("id").substr(6), sRow = 'nome' != sId ? sId.substr(4) : '';
    if ("" == $(this).val()) {
     do_ajax_control_licenca_tratamento_mob_event_nome_onchange(sRow);
    }
   },
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['recarga'];
}
?>
...
<?php
 include_once("control_licenca_tratamento_mob_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_licenca_tratamento_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_licenca_tratamento_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  if ($this->nmgp_form_empty)
  {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['empty_filter'] = true;
       }
  }
  else
  {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_licenca_tratamento_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("control_licenca_tratamento_mob");
 parent.scAjaxDetailHeight("control_licenca_tratamento_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
