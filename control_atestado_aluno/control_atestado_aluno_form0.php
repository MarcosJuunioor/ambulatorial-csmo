...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . ""); } else { echo strip_tags("Atestado aluno"); } ?></TITLE>
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_atestado_aluno']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>control_atestado_aluno/control_atestado_aluno_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("control_atestado_aluno_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_atestado_aluno_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-nome", elem).focus(function() {
   ...
   source: function (request, response) {
    $.ajax({
     url: "control_atestado_aluno.php",
     dataType: "json",
     data: {
      term: request.term,
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_atestado_aluno']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_atestado_aluno']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_atestado_aluno']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_atestado_aluno']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_atestado_aluno']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_atestado_aluno']['recarga'];
}
?>
...
<?php
 include_once("control_atestado_aluno_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_atestado_aluno'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_atestado_aluno'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_atestado_aluno']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_atestado_aluno']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . ""; } else { echo "Atestado aluno"; } ?></span></td>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_atestado_aluno']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_atestado_aluno']['empty_filter'] = true;
       }
  }
  else
  {
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['data_inicial'] = "Afastado de";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_atestado_aluno']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("control_atestado_aluno");
 parent.scAjaxDetailHeight("control_atestado_aluno", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
