...
<?php
include_once("form_prontuario_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_prontuario_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_prontuario']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_prontuario']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prontuario']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prontuario']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_prontuario']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prontuario']['recarga'];
}
?>
...
<?php
 include_once("form_prontuario_js0.php");
?>
<script type="text/javascript" src="<?php  echo $this->Ini->path_js . "/nm_rpc.js" ?>"> 
</script> 
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prontuario']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_prontuario']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_prontuario'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_prontuario'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prontuario']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_prontuario']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_prontuario']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prontuario']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prontuario']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prontuario']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prontuario']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_prontuario']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_prontuario']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_prontuario']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prontuario']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cep_label" id="hidden_field_label_cep" style="<?php echo $sStyleHidden_cep; ?>"><span id="id_label_cep"><?php echo $this->nm_new_label['cep']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prontuario']['php_cmp_required']['cep']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_prontuario']['php_cmp_required']['cep'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<span id="id_read_on_cep" class="sc-ui-readonly-cep css_cep_line" style="<?php echo $sStyleReadLab_cep; ?>"><?php echo $this->form_encode_input($this->cep); ?></span><span id="id_read_off_cep" style="white-space: nowrap;<?php echo $sStyleReadInp_cep; ?>">
 ...
 size=8 alt="{datatype: 'cep', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}">&nbsp;<?php echo nmButtonOutput($this->arr_buttons, "bzipcode", "tb_show('', '" . $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . SC_dir_app_name('form_prontuario'). "/form_prontuario_cep.php?cep=' + document.F1.cep.value + '&form_origem=F1;CEP,cep;UF,estado;CIDADE,cidade;BAIRRO,bairro;RUA,rua&TB_iframe=true&height=220&width=350&modal=true', '')", "tb_show('', '" . $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . SC_dir_app_name('form_prontuario'). "/form_prontuario_cep.php?cep=' + document.F1.cep.value + '&form_origem=F1;CEP,cep;UF,estado;CIDADE,cidade;BAIRRO,bairro;RUA,rua&TB_iframe=true&height=220&width=350&modal=true', '')", "cep_cep", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_prontuario']['Lookup_tipo_paciente'][] = 'aluno'; ?>
 <option value="servidor" <?php  if ($this->tipo_paciente == "servidor") { echo " selected" ;} ?>>Servidor</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_prontuario']['Lookup_tipo_paciente'][] = 'servidor'; ?>
 <option value="terceirizado" <?php  if ($this->tipo_paciente == "terceirizado") { echo " selected" ;} ?>>Terceirizado</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_prontuario']['Lookup_tipo_paciente'][] = 'terceirizado'; ?>
 <option value="visitante" <?php  if ($this->tipo_paciente == "visitante") { echo " selected" ;} ?>>Visitante</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_prontuario']['Lookup_tipo_paciente'][] = 'visitante'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_data_nascimento_label" id="hidden_field_label_data_nascimento" style="<?php echo $sStyleHidden_data_nascimento; ?>"><span id="id_label_data_nascimento"><?php echo $this->nm_new_label['data_nascimento']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prontuario']['php_cmp_required']['data_nascimento']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_prontuario']['php_cmp_required']['data_nascimento'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_prontuario_empty.htm' : $this->Ini->link_form_servidor_terceirizado_pront_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y');
?>
...
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_prontuario_empty.htm' : $this->Ini->link_form_servidor_pront_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y');
?>
...
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_prontuario_empty.htm' : $this->Ini->link_form_aluno_pront_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y');
?>
...
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_prontuario_empty.htm' : $this->Ini->link_form_visitante_pront_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y');
?>
...
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_prontuario_empty.htm' : $this->Ini->link_form_triagem_pront_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=300');
?>
...
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_prontuario_empty.htm' : $this->Ini->link_form_evolucao_medica_pront_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=480');
?>
...
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_prontuario_empty.htm' : $this->Ini->link_form_conduta_medica_pront_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=480');
?>
...
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_prontuario_empty.htm' : $this->Ini->link_form_evolucao_odontologica_pront_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=480');
?>
...
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_prontuario_empty.htm' : $this->Ini->link_form_conduta_odontologica_pront_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=480');
?>
...
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_prontuario_empty.htm' : $this->Ini->link_form_prescricao_pront_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=480');
?>
...
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_prontuario_empty.htm' : $this->Ini->link_form_registro_de_enfermagem_pront_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=480');
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prontuario']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_prontuario");
 parent.scAjaxDetailHeight("form_prontuario", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
