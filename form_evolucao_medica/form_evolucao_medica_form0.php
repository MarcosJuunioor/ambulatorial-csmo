...
<?php
include_once("form_evolucao_medica_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_evolucao_medica_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_medica']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_medica']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_medica']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_medica']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_medica']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_medica']['recarga'];
}
?>
...
<?php
 include_once("form_evolucao_medica_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_medica']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_medica']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_evolucao_medica'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_evolucao_medica'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_medica']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_medica']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_medica']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_medica']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_medica']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_medica']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_medica']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_medica']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_medica']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_medica']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_medica']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_evolucao_medica']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_evolucao_medica");
 parent.scAjaxDetailHeight("form_evolucao_medica", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
