...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['form_aluno']['glo_nm_conexao'], $this->root . $this->path_prod, 'sistema_csmo'); 
      } 
      else 
      { 
...
//
    ...
    if (isset($_POST['rs']) && !is_array($_POST['rs']) && 'ajax_' == substr($_POST['rs'], 0, 5) && isset($_POST['rsargs']) && !empty($_POST['rsargs']))
    {
        ...
        if ('ajax_form_aluno_validate_nome_responsavel' == $_POST['rs'])
        {
            $nome_responsavel = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_aluno_validate_id_campus' == $_POST['rs'])
        {
            $id_campus = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_aluno_validate_modalidade_curso' == $_POST['rs'])
        {
    ...
    else
    {
        ...
        if (isset($_POST["id_paciente"])) 
        {
            ...
            nm_limpa_str_form_aluno($_SESSION['id_paciente']);
        }
    ...
    $inicial_form_aluno->contr_form_aluno->NM_ajax_info['select_html']['id_campus'] = "class=\"sc-js-input scFormObjectOdd css_id_campus_obj\" style=\"\" id=\"id_sc_field_id_campus\" name=\"id_campus\" size=\"1\" alt=\"{type: 'select', enterTab: false}\"";
    $inicial_form_aluno->contr_form_aluno->NM_ajax_info['select_html']['modalidade_curso'] = "class=\"sc-js-input scFormObjectOdd css_modalidade_curso_obj\" style=\"\" id=\"id_sc_field_modalidade_curso\" name=\"modalidade_curso\" size=\"1\" alt=\"{type: \'select\', enterTab: false}\"";
    $inicial_form_aluno->contr_form_aluno->NM_ajax_info['select_html']['curso'] = "class=\"sc-js-input scFormObjectOdd css_curso_obj\" style=\"\" id=\"id_sc_field_curso\" name=\"curso\" size=\"1\" alt=\"{type: \'select\', enterTab: false}\"";
    ...
    sajax_export("ajax_form_aluno_validate_nome_responsavel");
    sajax_export("ajax_form_aluno_validate_id_campus");
    sajax_export("ajax_form_aluno_validate_modalidade_curso");
...
//
    ...
    function ajax_form_aluno_validate_nome_responsavel($nome_responsavel, $script_case_init)
    {
        global $inicial_form_aluno;
        //register_shutdown_function("form_aluno_pack_ajax_response");
        $inicial_form_aluno->contr_form_aluno->NM_ajax_flag          = true;
        $inicial_form_aluno->contr_form_aluno->NM_ajax_opcao         = 'validate_nome_responsavel';
        $inicial_form_aluno->contr_form_aluno->NM_ajax_info['param'] = array(
    ...
    function ajax_form_aluno_validate_id_campus($id_campus, $script_case_init)
    {
        global $inicial_form_aluno;
        //register_shutdown_function("form_aluno_pack_ajax_response");
        $inicial_form_aluno->contr_form_aluno->NM_ajax_flag          = true;
        $inicial_form_aluno->contr_form_aluno->NM_ajax_opcao         = 'validate_id_campus';
        $inicial_form_aluno->contr_form_aluno->NM_ajax_info['param'] = array(
    ...
    function ajax_form_aluno_validate_modalidade_curso($modalidade_curso, $script_case_init)
    {
        global $inicial_form_aluno;
        //register_shutdown_function("form_aluno_pack_ajax_response");
        $inicial_form_aluno->contr_form_aluno->NM_ajax_flag          = true;
        $inicial_form_aluno->contr_form_aluno->NM_ajax_opcao         = 'validate_modalidade_curso';
        $inicial_form_aluno->contr_form_aluno->NM_ajax_info['param'] = array(
    ...
    function ajax_form_aluno_submit_form($matricula, $nome_responsavel, $id_campus, $modalidade_curso, $curso, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token)
    {
        global $inicial_form_aluno;
        //register_shutdown_function("form_aluno_pack_ajax_response");
        $inicial_form_aluno->contr_form_aluno->NM_ajax_flag          = true;
