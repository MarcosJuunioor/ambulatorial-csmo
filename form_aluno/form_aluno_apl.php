...
//----- 
  ...
  $this->background();
$_SESSION['scriptcase']['sc_apl_conf']['form_aluno']['start'] = 'new';
$_SESSION['scriptcase']['form_aluno']['contr_erro'] = 'off';
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_aluno']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_aluno']['label'] = "Atualizar dados do Aluno";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['where_pesq'] = "";
...
$_SESSION['scriptcase']['form_aluno']['contr_erro'] = 'off'; 
    ...
    function ValidateField_matricula(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['php_cmp_required']['matricula']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['php_cmp_required']['matricula'] == "on")) 
      { 
          if ($this->matricula == "")  
          { 
    ...
    {
        global $teste_validade;
               if (!empty($this->id_campus) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_id_campus']) && !in_array($this->id_campus, $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_id_campus']))
               {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_id_campus']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_id_campus'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_id_campus']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_id_campus'] = array(); 
}
...
ORDER BY nome_campi";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_id_campus'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_campus']['valList'][$i] = form_aluno_pack_protect_string($v);
          }
...
$aLookup[] = array(form_aluno_pack_protect_string('tecnico') => form_aluno_pack_protect_string("Técnico"));
$aLookup[] = array(form_aluno_pack_protect_string('superior') => form_aluno_pack_protect_string("Superior"));
$aLookup[] = array(form_aluno_pack_protect_string('posgraduacao') => form_aluno_pack_protect_string("Pós-Graduação"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_modalidade_curso'][] = 'tecnico';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_modalidade_curso'][] = 'superior';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_modalidade_curso'][] = 'posgraduacao';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['modalidade_curso']['valList'][$i] = form_aluno_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_aluno_pack_protect_string('Administração') => form_aluno_pack_protect_string("Administração"));
$aLookup[] = array(form_aluno_pack_protect_string('Agricultor Familiar') => form_aluno_pack_protect_string("Agricultor Familiar"));
$aLookup[] = array(form_aluno_pack_protect_string('Agricultura') => form_aluno_pack_protect_string("Agricultura"));
$aLookup[] = array(form_aluno_pack_protect_string('Agroecologia') => form_aluno_pack_protect_string("Agroecologia"));
$aLookup[] = array(form_aluno_pack_protect_string('Agroindústria') => form_aluno_pack_protect_string("Agroindústria"));
$aLookup[] = array(form_aluno_pack_protect_string('Agronomia') => form_aluno_pack_protect_string("Agronomia"));
$aLookup[] = array(form_aluno_pack_protect_string('Agropecuária') => form_aluno_pack_protect_string("Agropecuária"));
$aLookup[] = array(form_aluno_pack_protect_string('Alimentos') => form_aluno_pack_protect_string("Alimentos"));
$aLookup[] = array(form_aluno_pack_protect_string('Almoxarife') => form_aluno_pack_protect_string("Almoxarife"));
$aLookup[] = array(form_aluno_pack_protect_string('Análise e Desenvolvimento de Sistemas') => form_aluno_pack_protect_string("Análise e Desenvolvimento de Sistemas"));
$aLookup[] = array(form_aluno_pack_protect_string('Artes Visuais') => form_aluno_pack_protect_string("Artes Visuais"));
$aLookup[] = array(form_aluno_pack_protect_string('Automação Industrial') => form_aluno_pack_protect_string("Automação Industrial"));
$aLookup[] = array(form_aluno_pack_protect_string('Auxiliar de Técnico em Agropecuária') => form_aluno_pack_protect_string("Auxiliar de Técnico em Agropecuária"));
$aLookup[] = array(form_aluno_pack_protect_string('Computação Gráfica') => form_aluno_pack_protect_string("Computação Gráfica"));
$aLookup[] = array(form_aluno_pack_protect_string('Construção Naval') => form_aluno_pack_protect_string("Construção Naval"));
$aLookup[] = array(form_aluno_pack_protect_string('Cozinha') => form_aluno_pack_protect_string("Cozinha"));
$aLookup[] = array(form_aluno_pack_protect_string('Desenvolvimento, Inovação e Tecnologias Emergentes') => form_aluno_pack_protect_string("Desenvolvimento, Inovação e Tecnologias Emergentes"));
$aLookup[] = array(form_aluno_pack_protect_string('Design Gráfico') => form_aluno_pack_protect_string("Design Gráfico"));
$aLookup[] = array(form_aluno_pack_protect_string('Edificações') => form_aluno_pack_protect_string("Edificações"));
$aLookup[] = array(form_aluno_pack_protect_string('Educação Profissional e Tecnológica (mestrado) ') => form_aluno_pack_protect_string("Educação Profissional e Tecnológica (mestrado) "));
$aLookup[] = array(form_aluno_pack_protect_string('Eletroeletrônica') => form_aluno_pack_protect_string("Eletroeletrônica"));
$aLookup[] = array(form_aluno_pack_protect_string('Eletrônica') => form_aluno_pack_protect_string("Eletrônica"));
$aLookup[] = array(form_aluno_pack_protect_string('Eletrotécnica') => form_aluno_pack_protect_string("Eletrotécnica"));
$aLookup[] = array(form_aluno_pack_protect_string('Enfermagem') => form_aluno_pack_protect_string("Enfermagem"));
$aLookup[] = array(form_aluno_pack_protect_string('Enfermagem (superior)') => form_aluno_pack_protect_string("Enfermagem (superior)"));
$aLookup[] = array(form_aluno_pack_protect_string('Engenharia Civil') => form_aluno_pack_protect_string("Engenharia Civil"));
$aLookup[] = array(form_aluno_pack_protect_string('Engenharia Elétrica') => form_aluno_pack_protect_string("Engenharia Elétrica"));
$aLookup[] = array(form_aluno_pack_protect_string('Engenharia Mecânica') => form_aluno_pack_protect_string("Engenharia Mecânica"));
$aLookup[] = array(form_aluno_pack_protect_string('Engenharia de Segurança do Trabalho') => form_aluno_pack_protect_string("Engenharia de Segurança do Trabalho"));
$aLookup[] = array(form_aluno_pack_protect_string('Ensino da Matemática para o Ensino Médio') => form_aluno_pack_protect_string("Ensino da Matemática para o Ensino Médio"));
$aLookup[] = array(form_aluno_pack_protect_string('Ensino de Ciências') => form_aluno_pack_protect_string("Ensino de Ciências"));
$aLookup[] = array(form_aluno_pack_protect_string('Gestão Ambiental (superior)') => form_aluno_pack_protect_string("Gestão Ambiental (superior)"));
$aLookup[] = array(form_aluno_pack_protect_string('Gestão Ambiental (mestrado)') => form_aluno_pack_protect_string("Gestão Ambiental (mestrado)"));
$aLookup[] = array(form_aluno_pack_protect_string('Gestão da Qualidade') => form_aluno_pack_protect_string("Gestão da Qualidade"));
$aLookup[] = array(form_aluno_pack_protect_string('Gestão de Turismo') => form_aluno_pack_protect_string("Gestão de Turismo"));
$aLookup[] = array(form_aluno_pack_protect_string('Gestão e Qualidade e Tecnologia da Informação e Comunicação') => form_aluno_pack_protect_string("Gestão e Qualidade e Tecnologia da Informação e Comunicação"));
$aLookup[] = array(form_aluno_pack_protect_string('Gestão Pública') => form_aluno_pack_protect_string("Gestão Pública"));
$aLookup[] = array(form_aluno_pack_protect_string('Hospedagem') => form_aluno_pack_protect_string("Hospedagem"));
$aLookup[] = array(form_aluno_pack_protect_string('Informática') => form_aluno_pack_protect_string("Informática"));
$aLookup[] = array(form_aluno_pack_protect_string('Informática para Internet') => form_aluno_pack_protect_string("Informática para Internet"));
$aLookup[] = array(form_aluno_pack_protect_string('Inovação e Desenvolvimento de Softwares para a Web e Dispositivos Móveis') => form_aluno_pack_protect_string("Inovação e Desenvolvimento de Softwares para a Web e Dispositivos Móveis"));
$aLookup[] = array(form_aluno_pack_protect_string('Instrumento Musical') => form_aluno_pack_protect_string("Instrumento Musical"));
$aLookup[] = array(form_aluno_pack_protect_string('Licenciatura em Física') => form_aluno_pack_protect_string("Licenciatura em Física"));
$aLookup[] = array(form_aluno_pack_protect_string('Licenciatura em Geografia') => form_aluno_pack_protect_string("Licenciatura em Geografia"));
$aLookup[] = array(form_aluno_pack_protect_string('Licenciatura em Matemática') => form_aluno_pack_protect_string("Licenciatura em Matemática"));
$aLookup[] = array(form_aluno_pack_protect_string('Licenciatura em Música') => form_aluno_pack_protect_string("Licenciatura em Música"));
$aLookup[] = array(form_aluno_pack_protect_string('Licenciatura em Química') => form_aluno_pack_protect_string("Licenciatura em Química"));
$aLookup[] = array(form_aluno_pack_protect_string('Logística') => form_aluno_pack_protect_string("Logística"));
$aLookup[] = array(form_aluno_pack_protect_string('Manutenção Automotiva') => form_aluno_pack_protect_string("Manutenção Automotiva"));
$aLookup[] = array(form_aluno_pack_protect_string('Manutenção e Suporte em Informática') => form_aluno_pack_protect_string("Manutenção e Suporte em Informática"));
$aLookup[] = array(form_aluno_pack_protect_string('Matemática (especialização)') => form_aluno_pack_protect_string("Matemática (especialização)"));
$aLookup[] = array(form_aluno_pack_protect_string('Mecânica') => form_aluno_pack_protect_string("Mecânica"));
$aLookup[] = array(form_aluno_pack_protect_string('Mecatrônica') => form_aluno_pack_protect_string("Mecatrônica"));
$aLookup[] = array(form_aluno_pack_protect_string('Meio Ambiente') => form_aluno_pack_protect_string("Meio Ambiente"));
$aLookup[] = array(form_aluno_pack_protect_string('Operador de Computador') => form_aluno_pack_protect_string("Operador de Computador"));
$aLookup[] = array(form_aluno_pack_protect_string('Operador de Processamento de Frutas e Hortaliças') => form_aluno_pack_protect_string("Operador de Processamento de Frutas e Hortaliças"));
$aLookup[] = array(form_aluno_pack_protect_string('Petroquímica') => form_aluno_pack_protect_string("Petroquímica"));
$aLookup[] = array(form_aluno_pack_protect_string('Qualidade') => form_aluno_pack_protect_string("Qualidade"));
$aLookup[] = array(form_aluno_pack_protect_string('Química') => form_aluno_pack_protect_string("Química"));
$aLookup[] = array(form_aluno_pack_protect_string('Radiologia') => form_aluno_pack_protect_string("Radiologia"));
$aLookup[] = array(form_aluno_pack_protect_string('Rede de Computadores') => form_aluno_pack_protect_string("Rede de Computadores"));
$aLookup[] = array(form_aluno_pack_protect_string('Refrigeração e Climatização') => form_aluno_pack_protect_string("Refrigeração e Climatização"));
$aLookup[] = array(form_aluno_pack_protect_string('Saneamento') => form_aluno_pack_protect_string("Saneamento"));
$aLookup[] = array(form_aluno_pack_protect_string('Segurança do Trabalho') => form_aluno_pack_protect_string("Segurança do Trabalho"));
$aLookup[] = array(form_aluno_pack_protect_string('Sistemas de Energia Renovável') => form_aluno_pack_protect_string("Sistemas de Energia Renovável"));
$aLookup[] = array(form_aluno_pack_protect_string('Telecomunicações') => form_aluno_pack_protect_string("Telecomunicações"));
$aLookup[] = array(form_aluno_pack_protect_string('Zootecnia') => form_aluno_pack_protect_string("Zootecnia"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Administração';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Agricultor Familiar';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Agricultura';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Agroecologia';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Agroindústria';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Agronomia';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Agropecuária';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Alimentos';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Almoxarife';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Análise e Desenvolvimento de Sistemas';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Artes Visuais';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Automação Industrial';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Auxiliar de Técnico em Agropecuária';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Computação Gráfica';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Construção Naval';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Cozinha';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Desenvolvimento, Inovação e Tecnologias Emergentes';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Design Gráfico';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Edificações';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Educação Profissional e Tecnológica (mestrado) ';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Eletroeletrônica';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Eletrônica';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Eletrotécnica';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Enfermagem';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Enfermagem (superior)';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Engenharia Civil';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Engenharia Elétrica';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Engenharia Mecânica';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Engenharia de Segurança do Trabalho';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Ensino da Matemática para o Ensino Médio';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Ensino de Ciências';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Gestão Ambiental (superior)';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Gestão Ambiental (mestrado)';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Gestão da Qualidade';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Gestão de Turismo';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Gestão e Qualidade e Tecnologia da Informação e Comunicação';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Gestão Pública';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Hospedagem';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Informática';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Informática para Internet';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Inovação e Desenvolvimento de Softwares para a Web e Dispositivos Móveis';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Instrumento Musical';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Licenciatura em Física';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Licenciatura em Geografia';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Licenciatura em Matemática';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Licenciatura em Música';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Licenciatura em Química';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Logística';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Manutenção Automotiva';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Manutenção e Suporte em Informática';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Matemática (especialização)';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Mecânica';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Mecatrônica';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Meio Ambiente';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Operador de Computador';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Operador de Processamento de Frutas e Hortaliças';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Petroquímica';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Qualidade';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Química';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Radiologia';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Rede de Computadores';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Refrigeração e Climatização';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Saneamento';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Segurança do Trabalho';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Sistemas de Energia Renovável';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Telecomunicações';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['Lookup_curso'][] = 'Zootecnia';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"curso\"";
          ...
          {
              $this->NM_ajax_info['fldList']['curso']['valList'][$i] = form_aluno_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->id_aluno)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['opcao'] = '';
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    $original_matricula = $this->matricula;
      ...
      $nm_select = "select matricula from aluno where matricula = $this->matricula "; 
...
$_SESSION['scriptcase']['form_aluno']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET matricula = '$this->matricula', nome_responsavel = '$this->nome_responsavel', modalidade_curso = '$this->modalidade_curso', curso = '$this->curso', id_campus = $this->id_campus";  
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET matricula = '$this->matricula', nome_responsavel = '$this->nome_responsavel', modalidade_curso = '$this->modalidade_curso', curso = '$this->curso', id_campus = $this->id_campus";  
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              { 
                  $comando_oracle = "UPDATE " . $this->Ini->nm_tabela . " SET matricula = '$this->matricula', nome_responsavel = '$this->nome_responsavel', modalidade_curso = '$this->modalidade_curso', curso = '$this->curso', id_campus = $this->id_campus";  
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              { 
                  $comando_oracle = "UPDATE " . $this->Ini->nm_tabela . " SET matricula = '$this->matricula', nome_responsavel = '$this->nome_responsavel', modalidade_curso = '$this->modalidade_curso', curso = '$this->curso', id_campus = $this->id_campus";  
          ...
          $this->curso = $this->curso_before_qstr;
              ...
              $this->nmgp_refresh_fields = array_diff(array('matricula', 'nome_responsavel', 'id_campus', 'modalidade_curso', 'curso'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          { 
              ...
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
...
<?php
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
