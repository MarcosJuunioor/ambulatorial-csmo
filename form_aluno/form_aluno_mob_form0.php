...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("Cadastrar Aluno"); } else { echo strip_tags("Atualizar dados do Aluno"); } ?></TITLE>
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php if ($this->nmgp_opcao == "novo") { echo "Cadastrar Aluno"; } else { echo "Atualizar dados do Aluno"; } ?></span></td>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_modalidade_curso'][] = 'tecnico'; ?>
 <option value="superior" <?php  if ($this->modalidade_curso == "superior") { echo " selected" ;} ?>>Superior</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_modalidade_curso'][] = 'superior'; ?>
 <option value="posgraduacao" <?php  if ($this->modalidade_curso == "posgraduacao") { echo " selected" ;} ?>>Pós-Graduação</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_modalidade_curso'][] = 'posgraduacao'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Administração'; ?>
 <option value="Agricultor Familiar" <?php  if ($this->curso == "Agricultor Familiar") { echo " selected" ;} ?>>Agricultor Familiar</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Agricultor Familiar'; ?>
 <option value="Agricultura" <?php  if ($this->curso == "Agricultura") { echo " selected" ;} ?>>Agricultura</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Agricultura'; ?>
 <option value="Agroecologia" <?php  if ($this->curso == "Agroecologia") { echo " selected" ;} ?>>Agroecologia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Agroecologia'; ?>
 <option value="Agroindústria" <?php  if ($this->curso == "Agroindústria") { echo " selected" ;} ?>>Agroindústria</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Agroindústria'; ?>
 <option value="Agronomia" <?php  if ($this->curso == "Agronomia") { echo " selected" ;} ?>>Agronomia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Agronomia'; ?>
 <option value="Agropecuária" <?php  if ($this->curso == "Agropecuária") { echo " selected" ;} ?>>Agropecuária</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Agropecuária'; ?>
 <option value="Alimentos" <?php  if ($this->curso == "Alimentos") { echo " selected" ;} ?>>Alimentos</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Alimentos'; ?>
 <option value="Almoxarife" <?php  if ($this->curso == "Almoxarife") { echo " selected" ;} ?>>Almoxarife</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Almoxarife'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Análise e Desenvolvimento de Sistemas'; ?>
 <option value="Artes Visuais" <?php  if ($this->curso == "Artes Visuais") { echo " selected" ;} ?>>Artes Visuais</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Artes Visuais'; ?>
 <option value="Automação Industrial" <?php  if ($this->curso == "Automação Industrial") { echo " selected" ;} ?>>Automação Industrial</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Automação Industrial'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Auxiliar de Técnico em Agropecuária'; ?>
 <option value="Computação Gráfica" <?php  if ($this->curso == "Computação Gráfica") { echo " selected" ;} ?>>Computação Gráfica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Computação Gráfica'; ?>
 <option value="Construção Naval" <?php  if ($this->curso == "Construção Naval") { echo " selected" ;} ?>>Construção Naval</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Construção Naval'; ?>
 <option value="Cozinha" <?php  if ($this->curso == "Cozinha") { echo " selected" ;} ?>>Cozinha</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Cozinha'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Desenvolvimento, Inovação e Tecnologias Emergentes'; ?>
 <option value="Design Gráfico" <?php  if ($this->curso == "Design Gráfico") { echo " selected" ;} ?>>Design Gráfico</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Design Gráfico'; ?>
 <option value="Edificações" <?php  if ($this->curso == "Edificações") { echo " selected" ;} ?>>Edificações</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Edificações'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Engenharia de Segurança do Trabalho'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Ensino da Matemática para o Ensino Médio'; ?>
 <option value="Ensino de Ciências" <?php  if ($this->curso == "Ensino de Ciências") { echo " selected" ;} ?>>Ensino de Ciências</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Ensino de Ciências'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Gestão Ambiental (superior)'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Gestão Ambiental (mestrado)'; ?>
 <option value="Gestão da Qualidade" <?php  if ($this->curso == "Gestão da Qualidade") { echo " selected" ;} ?>>Gestão da Qualidade</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Gestão da Qualidade'; ?>
 <option value="Gestão de Turismo" <?php  if ($this->curso == "Gestão de Turismo") { echo " selected" ;} ?>>Gestão de Turismo</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Gestão de Turismo'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Gestão e Qualidade e Tecnologia da Informação e Comunicação'; ?>
 <option value="Gestão Pública" <?php  if ($this->curso == "Gestão Pública") { echo " selected" ;} ?>>Gestão Pública</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Gestão Pública'; ?>
 <option value="Hospedagem" <?php  if ($this->curso == "Hospedagem") { echo " selected" ;} ?>>Hospedagem</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Hospedagem'; ?>
 <option value="Informática" <?php  if ($this->curso == "Informática") { echo " selected" ;} ?>>Informática</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Informática'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Informática para Internet'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Inovação e Desenvolvimento de Softwares para a Web e Dispositivos Móveis'; ?>
 <option value="Instrumento Musical" <?php  if ($this->curso == "Instrumento Musical") { echo " selected" ;} ?>>Instrumento Musical</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Instrumento Musical'; ?>
 <option value="Licenciatura em Física" <?php  if ($this->curso == "Licenciatura em Física") { echo " selected" ;} ?>>Licenciatura em Física</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Licenciatura em Física'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Licenciatura em Geografia'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Licenciatura em Matemática'; ?>
 <option value="Licenciatura em Música" <?php  if ($this->curso == "Licenciatura em Música") { echo " selected" ;} ?>>Licenciatura em Música</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Licenciatura em Música'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Licenciatura em Química'; ?>
 <option value="Logística" <?php  if ($this->curso == "Logística") { echo " selected" ;} ?>>Logística</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Logística'; ?>
 <option value="Manutenção Automotiva" <?php  if ($this->curso == "Manutenção Automotiva") { echo " selected" ;} ?>>Manutenção Automotiva</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Manutenção Automotiva'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Manutenção e Suporte em Informática'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Matemática (especialização)'; ?>
 <option value="Mecânica" <?php  if ($this->curso == "Mecânica") { echo " selected" ;} ?>>Mecânica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Mecânica'; ?>
 <option value="Mecatrônica" <?php  if ($this->curso == "Mecatrônica") { echo " selected" ;} ?>>Mecatrônica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Mecatrônica'; ?>
 <option value="Meio Ambiente" <?php  if ($this->curso == "Meio Ambiente") { echo " selected" ;} ?>>Meio Ambiente</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Meio Ambiente'; ?>
 <option value="Operador de Computador" <?php  if ($this->curso == "Operador de Computador") { echo " selected" ;} ?>>Operador de Computador</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Operador de Computador'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Operador de Processamento de Frutas e Hortaliças'; ?>
 <option value="Petroquímica" <?php  if ($this->curso == "Petroquímica") { echo " selected" ;} ?>>Petroquímica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Petroquímica'; ?>
 <option value="Qualidade" <?php  if ($this->curso == "Qualidade") { echo " selected" ;} ?>>Qualidade</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Qualidade'; ?>
 <option value="Química" <?php  if ($this->curso == "Química") { echo " selected" ;} ?>>Química</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Química'; ?>
 <option value="Radiologia" <?php  if ($this->curso == "Radiologia") { echo " selected" ;} ?>>Radiologia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Radiologia'; ?>
 <option value="Rede de Computadores" <?php  if ($this->curso == "Rede de Computadores") { echo " selected" ;} ?>>Rede de Computadores</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Rede de Computadores'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Refrigeração e Climatização'; ?>
 <option value="Saneamento" <?php  if ($this->curso == "Saneamento") { echo " selected" ;} ?>>Saneamento</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Saneamento'; ?>
 <option value="Segurança do Trabalho" <?php  if ($this->curso == "Segurança do Trabalho") { echo " selected" ;} ?>>Segurança do Trabalho</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Segurança do Trabalho'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Sistemas de Energia Renovável'; ?>
 <option value="Telecomunicações" <?php  if ($this->curso == "Telecomunicações") { echo " selected" ;} ?>>Telecomunicações</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Telecomunicações'; ?>
 <option value="Zootecnia" <?php  if ($this->curso == "Zootecnia") { echo " selected" ;} ?>>Zootecnia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_curso'][] = 'Zootecnia'; ?>
 </select></span>
</span><?php  }?>
