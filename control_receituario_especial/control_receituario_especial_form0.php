...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . ""); } else { echo strip_tags("Receituário especial"); } ?></TITLE>
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_receituario_especial']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>control_receituario_especial/control_receituario_especial_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("control_receituario_especial_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_receituario_especial_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-nome", elem).focus(function() {
   ...
   source: function (request, response) {
    $.ajax({
     url: "control_receituario_especial.php",
     dataType: "json",
     data: {
      term: request.term,
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_receituario_especial']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_receituario_especial']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_receituario_especial']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_receituario_especial']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_receituario_especial']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_receituario_especial']['recarga'];
}
?>
...
<?php
 include_once("control_receituario_especial_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_receituario_especial'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_receituario_especial'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_receituario_especial']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_receituario_especial']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . ""; } else { echo "Receituário especial"; } ?></span></td>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_receituario_especial']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_receituario_especial']['empty_filter'] = true;
       }
  }
  else
  {
...
<TABLE align="center" id="hidden_bloco_0" class="scFormTable" width="100%" style="height: 100%;"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['nome'] = "Paciente";
    }
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_endereco_label" id="hidden_field_label_endereco" style="<?php echo $sStyleHidden_endereco; ?>"><span id="id_label_endereco"><?php echo $this->nm_new_label['endereco']; ?></span></TD>
    <TD class="scFormDataOdd css_endereco_line" id="hidden_field_data_endereco" style="<?php echo $sStyleHidden_endereco; ?>">
<?php
$endereco_val = str_replace('<br />', '__SC_BREAK_LINE__', nl2br($endereco));
...
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["endereco"]) &&  $this->nmgp_cmp_readonly["endereco"] == "on") { 
 ...
 ?>
<input type="hidden" name="endereco" value="<?php echo $this->form_encode_input($endereco) . "\">" . $endereco_val . ""; ?>
<?php } else { ?>
<span id="id_read_on_endereco" class="sc-ui-readonly-endereco css_endereco_line" style="<?php echo $sStyleReadLab_endereco; ?>"><?php echo $this->form_encode_input($endereco_val); ?></span><span id="id_read_off_endereco" style="white-space: nowrap;<?php echo $sStyleReadInp_endereco; ?>">
 <textarea  class="sc-js-input scFormObjectOdd css_endereco_obj" style="white-space: pre-wrap;" name="endereco" id="id_sc_field_endereco" rows="2" cols="52"
 alt="{datatype: 'text', maxLength: 160, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}">
<?php echo $endereco; ?>
</textarea>
</span><?php } ?>
</TD>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['prescricao'] = "Prescrição";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_prescricao_label" id="hidden_field_label_prescricao" style="<?php echo $sStyleHidden_prescricao; ?>"><span id="id_label_prescricao"><?php echo $this->nm_new_label['prescricao']; ?></span></TD>
    <TD class="scFormDataOdd css_prescricao_line" id="hidden_field_data_prescricao" style="<?php echo $sStyleHidden_prescricao; ?>">
<?php
$prescricao_val = str_replace('<br />', '__SC_BREAK_LINE__', nl2br($prescricao));

?>

<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["prescricao"]) &&  $this->nmgp_cmp_readonly["prescricao"] == "on") { 

 ?>
<input type="hidden" name="prescricao" value="<?php echo $this->form_encode_input($prescricao) . "\">" . $prescricao_val . ""; ?>
<?php } else { ?>
<span id="id_read_on_prescricao" class="sc-ui-readonly-prescricao css_prescricao_line" style="<?php echo $sStyleReadLab_prescricao; ?>"><?php echo $this->form_encode_input($prescricao_val); ?></span><span id="id_read_off_prescricao" style="white-space: nowrap;<?php echo $sStyleReadInp_prescricao; ?>">
 <textarea  class="sc-js-input scFormObjectOdd css_prescricao_obj" style="white-space: pre-wrap;" name="prescricao" id="id_sc_field_prescricao" rows="14" cols="52"
 alt="{datatype: 'text', maxLength: 728, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}">
<?php echo $prescricao; ?>
</textarea>
</span><?php } ?>
</TD>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_receituario_especial']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("control_receituario_especial");
 parent.scAjaxDetailHeight("control_receituario_especial", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
