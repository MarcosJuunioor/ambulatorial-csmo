...
<?php
include_once("form_prescricao_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_prescricao_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_prescricao']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_prescricao']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prescricao']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prescricao']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_prescricao']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_prescricao']['recarga'];
}
?>
...
<?php
 include_once("form_prescricao_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_prescricao']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_prescricao']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_prescricao'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_prescricao'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prescricao']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_prescricao']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_prescricao']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prescricao']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prescricao']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_prescricao']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_prescricao']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_prescricao']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_prescricao']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_prescricao_label" id="hidden_field_label_id_prescricao" style="<?php echo $sStyleHidden_id_prescricao; ?>"><span id="id_label_id_prescricao"><?php echo $this->nm_new_label['id_prescricao']; ?></span></TD>
    <TD class="scFormDataOdd css_id_prescricao_line" id="hidden_field_data_id_prescricao" style="<?php echo $sStyleHidden_id_prescricao; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_prescricao_line" style="vertical-align: top;padding: 0px"><span id="id_read_on_id_prescricao" class="css_id_prescricao_line" style="<?php echo $sStyleReadLab_id_prescricao; ?>"><?php echo $this->form_encode_input($this->id_prescricao); ?></span><span id="id_read_off_id_prescricao" style="<?php echo $sStyleReadInp_id_prescricao; ?>"><input type="hidden" name="id_prescricao" value="<?php echo $this->form_encode_input($id_prescricao) . "\">"?><span id="id_ajax_label_id_prescricao"><?php echo nl2br($id_prescricao); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_medicamento_label" id="hidden_field_label_medicamento" style="<?php echo $sStyleHidden_medicamento; ?>"><span id="id_label_medicamento"><?php echo $this->nm_new_label['medicamento']; ?></span></TD>
    <TD class="scFormDataOdd css_medicamento_line" id="hidden_field_data_medicamento" style="<?php echo $sStyleHidden_medicamento; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_medicamento_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_prescritor_label" id="hidden_field_label_prescritor" style="<?php echo $sStyleHidden_prescritor; ?>"><span id="id_label_prescritor"><?php echo $this->nm_new_label['prescritor']; ?></span></TD>
    <TD class="scFormDataOdd css_prescritor_line" id="hidden_field_data_prescritor" style="<?php echo $sStyleHidden_prescritor; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_prescritor_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="prescritor" value="<?php echo $this->form_encode_input($prescritor); ?>"><span id="id_ajax_label_prescritor"><?php echo nl2br($prescritor); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_hora_de_adm_label" id="hidden_field_label_hora_de_adm" style="<?php echo $sStyleHidden_hora_de_adm; ?>"><span id="id_label_hora_de_adm"><?php echo $this->nm_new_label['hora_de_adm']; ?></span></TD>
    <TD class="scFormDataOdd css_hora_de_adm_line" id="hidden_field_data_hora_de_adm" style="<?php echo $sStyleHidden_hora_de_adm; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_hora_de_adm_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_prof_que_adm_label" id="hidden_field_label_prof_que_adm" style="<?php echo $sStyleHidden_prof_que_adm; ?>"><span id="id_label_prof_que_adm"><?php echo $this->nm_new_label['prof_que_adm']; ?></span></TD>
    <TD class="scFormDataOdd css_prof_que_adm_line" id="hidden_field_data_prof_que_adm" style="<?php echo $sStyleHidden_prof_que_adm; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_prof_que_adm_line" style="vertical-align: top;padding: 0px">
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_prescricao']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_prescricao");
 parent.scAjaxDetailHeight("form_prescricao", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
