...
<?php
include_once("form_conduta_odontologica_pront_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_conduta_odontologica_pront_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-id_paciente", elem).focus(function() {
   ...
   source: function (request, response) {
    $.ajax({
     url: "form_conduta_odontologica_pront.php",
     dataType: "json",
     data: {
      term: request.term,
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_conduta_odontologica_pront']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_conduta_odontologica_pront']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_conduta_odontologica_pront']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_conduta_odontologica_pront']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_conduta_odontologica_pront']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_conduta_odontologica_pront']['recarga'];
}
?>
...
<?php
 include_once("form_conduta_odontologica_pront_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_conduta_odontologica_pront']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_conduta_odontologica_pront']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_conduta_odontologica_pront'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_conduta_odontologica_pront'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_conduta_odontologica_pront']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_conduta_odontologica_pront']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_conduta_odontologica_pront']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_conduta_odontologica_pront']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_conduta_odontologica_pront']['run_iframe'] != "R")
{
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_data_cadastro_label" id="hidden_field_label_data_cadastro" style="<?php echo $sStyleHidden_data_cadastro; ?>"><span id="id_label_data_cadastro"><?php echo $this->nm_new_label['data_cadastro']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_conduta_odontologica_pront']['php_cmp_required']['data_cadastro']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_conduta_odontologica_pront']['php_cmp_required']['data_cadastro'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_texto_label" id="hidden_field_label_texto" style="<?php echo $sStyleHidden_texto; ?>"><span id="id_label_texto"><?php echo $this->nm_new_label['texto']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_conduta_odontologica_pront']['php_cmp_required']['texto']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_conduta_odontologica_pront']['php_cmp_required']['texto'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_conduta_odontologica_pront']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_conduta_odontologica_pront");
 parent.scAjaxDetailHeight("form_conduta_odontologica_pront", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
