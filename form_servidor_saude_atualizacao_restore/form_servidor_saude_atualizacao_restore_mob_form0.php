...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_servidor_saude_atualizacao_restore/form_servidor_saude_atualizacao_restore_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_servidor_saude_atualizacao_restore_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_servidor_saude_atualizacao_restore_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['recarga'];
}
?>
...
<?php
 include_once("form_servidor_saude_atualizacao_restore_mob_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_servidor_saude_atualizacao_restore_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_servidor_saude_atualizacao_restore_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['Lookup_cargo'][] = 'assistente_de_dentista'; ?>
 <option value="dentista" <?php  if ($this->cargo == "dentista") { echo " selected" ;} ?>>Dentista</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['Lookup_cargo'][] = 'dentista'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['Lookup_cargo'][] = 'enfermeiro'; ?>
 <option value="tecnico" <?php  if ($this->cargo == "tecnico") { echo " selected" ;} ?>>Técnico(a) em enfermagem</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['Lookup_cargo'][] = 'tecnico'; ?>
 <option value="medico" <?php  if ($this->cargo == "medico") { echo " selected" ;} ?>>Médico(a)</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['Lookup_cargo'][] = 'medico'; ?>
 <option value="recepcionista" <?php  if ($this->cargo == "recepcionista") { echo " selected" ;} ?>>Recepcionista</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['Lookup_cargo'][] = 'recepcionista'; ?>
 <option value="gestor" <?php  if ($this->cargo == "gestor") { echo " selected" ;} ?>>Gestor</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['Lookup_cargo'][] = 'gestor'; ?>
 <option value="gestor_crm" <?php  if ($this->cargo == "gestor_crm") { echo " selected" ;} ?>>Gestor c/ CRM</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['Lookup_cargo'][] = 'gestor_crm'; ?>
 <option value="gestor_cro" <?php  if ($this->cargo == "gestor_cro") { echo " selected" ;} ?>>Gestor c/ CRO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['Lookup_cargo'][] = 'gestor_cro'; ?>
 <option value="gestor_coren" <?php  if ($this->cargo == "gestor_coren") { echo " selected" ;} ?>>Gestor c/ COREN</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['Lookup_cargo'][] = 'gestor_coren'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_siape_line" id="hidden_field_data_siape" style="<?php echo $sStyleHidden_siape; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_siape_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_siape_label"><span id="id_label_siape"><?php echo $this->nm_new_label['siape']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['php_cmp_required']['siape']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['php_cmp_required']['siape'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['mostra_cab'] != "N"))
  {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_saude_atualizacao_restore_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_servidor_saude_atualizacao_restore_mob");
 parent.scAjaxDetailHeight("form_servidor_saude_atualizacao_restore_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
