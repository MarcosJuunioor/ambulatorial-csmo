  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_servidor_terceirizado_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate empresa
  function do_ajax_form_servidor_terceirizado_mob_validate_empresa()
  {
    var nomeCampo_empresa = "empresa";
    var var_empresa = scAjaxGetFieldText(nomeCampo_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servidor_terceirizado_mob_validate_empresa(var_empresa, var_script_case_init, do_ajax_form_servidor_terceirizado_mob_validate_empresa_cb);
  } // do_ajax_form_servidor_terceirizado_mob_validate_empresa

  function do_ajax_form_servidor_terceirizado_mob_validate_empresa_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servidor_terceirizado_mob_validate_empresa_cb

  // ---------- Validate matricula
  function do_ajax_form_servidor_terceirizado_mob_validate_matricula()
  {
    var nomeCampo_matricula = "matricula";
    var var_matricula = scAjaxGetFieldText(nomeCampo_matricula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servidor_terceirizado_mob_validate_matricula(var_matricula, var_script_case_init, do_ajax_form_servidor_terceirizado_mob_validate_matricula_cb);
  } // do_ajax_form_servidor_terceirizado_mob_validate_matricula

  function do_ajax_form_servidor_terceirizado_mob_validate_matricula_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servidor_terceirizado_mob_validate_matricula_cb

  // ---------- Validate id_campus
  function do_ajax_form_servidor_terceirizado_mob_validate_id_campus()
  {
    var nomeCampo_id_campus = "id_campus";
    var var_id_campus = scAjaxGetFieldSelect(nomeCampo_id_campus);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servidor_terceirizado_mob_validate_id_campus(var_id_campus, var_script_case_init, do_ajax_form_servidor_terceirizado_mob_validate_id_campus_cb);
  } // do_ajax_form_servidor_terceirizado_mob_validate_id_campus

  function do_ajax_form_servidor_terceirizado_mob_validate_id_campus_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servidor_terceirizado_mob_validate_id_campus_cb
  // ---------- Form
  function do_ajax_form_servidor_terceirizado_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_servidor_terceirizado_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_servidor_terceirizado_mob_submit_form(var_empresa, var_matricula, var_id_campus, var_id_servidor_terceirizado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_servidor_terceirizado_mob_submit_form_cb);
  } // do_ajax_form_servidor_terceirizado_mob_submit_form

  function do_ajax_form_servidor_terceirizado_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_servidor_terceirizado_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_servidor_terceirizado_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_servidor_terceirizado_mob_navigate_form(var_id_servidor_terceirizado, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_servidor_terceirizado_mob_navigate_form_cb);
  } // do_ajax_form_servidor_terceirizado_mob_navigate_form

  function do_ajax_form_servidor_terceirizado_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_servidor_terceirizado_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
...
{
?>
    do_ajax_form_servidor_terceirizado_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_servidor_terceirizado_mob_navigate_form_cb
  function sc_hide_form_servidor_terceirizado_mob_form()
  {
