...
<?php
include_once("control_ficha_de_acompanhamento_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_ficha_de_acompanhamento_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-nome", elem).focus(function() {
   ...
   source: function (request, response) {
    $.ajax({
     url: "control_ficha_de_acompanhamento.php",
     dataType: "json",
     data: {
      term: request.term,
   ...
   change: function (event, ui) {
    var sId = $(this).attr("id").substr(6), sRow = 'nome' != sId ? sId.substr(4) : '';
    if ("" == $(this).val()) {
     do_ajax_control_ficha_de_acompanhamento_event_nome_onchange(sRow);
    }
   },
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_ficha_de_acompanhamento']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_ficha_de_acompanhamento']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_ficha_de_acompanhamento']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_ficha_de_acompanhamento']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_ficha_de_acompanhamento']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_ficha_de_acompanhamento']['recarga'];
}
?>
...
<?php
 include_once("control_ficha_de_acompanhamento_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_ficha_de_acompanhamento'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_ficha_de_acompanhamento'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_ficha_de_acompanhamento']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_ficha_de_acompanhamento']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  if ($this->nmgp_form_empty)
  {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_ficha_de_acompanhamento']['empty_filter'] = true;
       }
  }
  else
  {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_curso_line" id="hidden_field_data_curso" style="<?php echo $sStyleHidden_curso; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_modalidade_label" id="hidden_field_label_modalidade" style="<?php echo $sStyleHidden_modalidade; ?>"><span id="id_label_modalidade"><?php echo $this->nm_new_label['modalidade']; ?></span></TD>
    <TD class="scFormDataOdd css_modalidade_line" id="hidden_field_data_modalidade" style="<?php echo $sStyleHidden_modalidade; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_data_nascimento_line" id="hidden_field_data_data_nascimento" style="<?php echo $sStyleHidden_data_nascimento; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_turno_line" id="hidden_field_data_turno" style="<?php echo $sStyleHidden_turno; ?>">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_ficha_de_acompanhamento']['Lookup_turno'][] = 'manha'; ?>
 <option value="tarde" <?php  if ($this->turno == "tarde") { echo " selected" ;} ?>>Tarde</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_ficha_de_acompanhamento']['Lookup_turno'][] = 'tarde'; ?>
 <option value="noite" <?php  if ($this->turno == "noite") { echo " selected" ;} ?>>Noite</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_ficha_de_acompanhamento']['Lookup_turno'][] = 'noite'; ?>
 </select></span>
</span><?php  }?>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_texto_line" id="hidden_field_data_texto" style="<?php echo $sStyleHidden_texto; ?>">
<?php
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_ficha_de_acompanhamento']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("control_ficha_de_acompanhamento");
 parent.scAjaxDetailHeight("control_ficha_de_acompanhamento", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
