...
<?php
include_once("form_servidor_terceirizado_atualizacao_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_servidor_terceirizado_atualizacao_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_terceirizado_atualizacao']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_terceirizado_atualizacao']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_terceirizado_atualizacao']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_terceirizado_atualizacao']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_terceirizado_atualizacao']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_terceirizado_atualizacao']['recarga'];
}
?>
...
<?php
 include_once("form_servidor_terceirizado_atualizacao_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_terceirizado_atualizacao']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_terceirizado_atualizacao']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_servidor_terceirizado_atualizacao'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_servidor_terceirizado_atualizacao'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_terceirizado_atualizacao']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_terceirizado_atualizacao']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_terceirizado_atualizacao']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_terceirizado_atualizacao']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_terceirizado_atualizacao']['run_iframe'] != "R")
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_servidor_terceirizado_atualizacao']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_servidor_terceirizado_atualizacao");
 parent.scAjaxDetailHeight("form_servidor_terceirizado_atualizacao", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
